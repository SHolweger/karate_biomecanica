...
| **Fecha y hora de inicio** | 2026-09-14 19:00:50 |
| **Duración total** | 2.64 s |
...
|---|---|---|---|---|---|
| Unitaria | 295 | 295 | 0 | 0 | 0.10 |
| Integración | 134 | 134 | 0 | 0 | 2.19 |
| **Total** | **429** | **429** | **0** | **0** | **2.29** |
...
| `test_un_kokutsu_real_no_se_confunde_con_una_transicion[170-100]` | PASSED | 1.1 |
...
| Prueba | Estado | Tiempo (ms) |
|---|---|---|
| `test_el_primer_uso_registra_al_entrenador_principal` | PASSED | 12.4 |
| `test_login_exitoso_de_un_entrenador_existente` | PASSED | 10.1 |
| `test_reintento_tras_una_contrasena_equivocada` | PASSED | 11.2 |
| `test_tras_fallar_puede_crear_una_cuenta_de_sensei_asistente` | PASSED | 13.7 |
| `test_elegir_un_perfil_existente_de_la_lista` | PASSED | 12.1 |
| `test_crear_un_perfil_nuevo_desde_la_lista` | PASSED | 11.0 |
| `test_el_grado_del_cinturon_es_opcional` | PASSED | 11.9 |
| `test_una_opcion_invalida_vuelve_a_preguntar[abc-texto en vez de n\xfamero]` | PASSED | 9.7 |
| `test_una_opcion_invalida_vuelve_a_preguntar[0-n\xfamero fuera de rango por abajo]` | PASSED | 11.2 |
| `test_una_opcion_invalida_vuelve_a_preguntar[99-n\xfamero fuera de rango por arriba]` | PASSED | 13.0 |

### `tests/integration/test_configuracion.py`

| Prueba | Estado | Tiempo (ms) |
|---|---|---|
| `test_una_preferencia_no_configurada_devuelve_el_valor_por_defecto` | PASSED | 8.7 |
| `test_la_preferencia_sobrevive_al_reinicio_del_sistema` | PASSED | 9.7 |
| `test_reconfigurar_reemplaza_en_vez_de_duplicar` | PASSED | 12.0 |
| `test_los_valores_se_guardan_como_texto` | PASSED | 8.9 |
| `test_la_migracion_no_toca_una_base_ya_existente` | PASSED | 8.6 |

### `tests/integration/test_consultas_progreso.py`

| Prueba | Estado | Tiempo (ms) |
|---|---|---|
| `test_la_precision_ignora_los_estados_transitorios` | PASSED | 17.0 |
| `test_un_alumno_sin_mediciones_aparece_con_precision_desconocida` | PASSED | 17.9 |
| `test_todos_los_alumnos_aparecen_aunque_no_hayan_entrenado` | PASSED | 18.9 |
| `test_las_sesiones_se_listan_de_la_mas_reciente_a_la_mas_antigua` | PASSED | 16.2 |
| `test_cada_sesion_trae_su_propia_precision` | PASSED | 18.4 |
| `test_una_sesion_abierta_se_distingue_de_una_cerrada` | PASSED | 20.6 |
| `test_un_alumno_sin_sesiones_devuelve_lista_vacia` | PASSED | 17.8 |
| `test_las_tecnicas_se_ordenan_de_la_mas_floja_a_la_mas_solida` | PASSED | 19.9 |
| `test_el_desempeno_puede_acotarse_a_una_sola_sesion` | PASSED | 18.0 |
| `test_el_angulo_medio_se_promedia_por_tecnica` | PASSED | 19.2 |
| `test_el_detalle_de_sesion_identifica_al_alumno_y_al_entrenador` | PASSED | 20.4 |
| `test_una_sesion_inexistente_devuelve_none` | PASSED | 18.5 |
| `test_los_errores_se_agrupan_y_ordenan_por_frecuencia` | PASSED | 19.2 |
...
| Prueba | Estado | Tiempo (ms) |
|---|---|---|
| `test_primer_arranque_no_tiene_entrenadores` | PASSED | 8.4 |
| `test_registro_y_autenticacion_exitosa` | PASSED | 9.0 |
...
| `test_credenciales_invalidas_no_dan_acceso[SHOLWEGER-clave123-usuario con distinta capitalizaci\xf3n]` | PASSED | 10.1 |
| `test_credenciales_invalidas_no_dan_acceso[--credenciales vac\xedas]` | PASSED | 9.9 |
| `test_la_contrasena_nunca_se_guarda_en_texto_plano` | PASSED | 9.8 |
| `test_no_se_permiten_dos_entrenadores_con_el_mismo_usuario` | PASSED | 10.1 |
| `test_el_rol_por_defecto_es_sensei` | PASSED | 9.4 |
| `test_los_atletas_se_listan_alfabeticamente` | PASSED | 11.3 |
| `test_crear_atleta_devuelve_un_identificador_utilizable` | PASSED | 8.3 |
| `test_los_datos_opcionales_del_atleta_pueden_omitirse` | PASSED | 9.6 |
| `test_una_sesion_abierta_no_tiene_hora_de_fin` | PASSED | 12.0 |
| `test_cerrar_sesion_registra_la_hora_de_fin` | PASSED | 12.0 |
| `test_la_sesion_queda_ligada_al_atleta_y_al_entrenador` | PASSED | 10.7 |
| `test_guardar_y_recuperar_una_medicion` | PASSED | 16.5 |
| `test_el_veredicto_se_persiste_en_los_tres_estados[True-1]` | PASSED | 15.5 |
| `test_el_veredicto_se_persiste_en_los_tres_estados[False-0]` | PASSED | 14.7 |
| `test_el_veredicto_se_persiste_en_los_tres_estados[None-None]` | PASSED | 69.2 |
| `test_el_historial_solo_devuelve_las_mediciones_del_atleta_consultado` | PASSED | 13.9 |
| `test_un_atleta_sin_entrenamientos_tiene_historial_vacio` | PASSED | 10.4 |
| `test_las_mediciones_sobreviven_al_cierre_de_la_aplicacion` | PASSED | 12.3 |
| `test_migra_una_base_de_datos_creada_sin_la_columna_correcto` | PASSED | 12.5 |
| `test_abrir_dos_veces_la_misma_base_no_duplica_el_esquema` | PASSED | 10.6 |
...
| `test_patada_lenta_se_diagnostica_sin_explosividad` | PASSED | 0.4 |
...
| Prueba | Estado | Tiempo (ms) |
|---|---|---|
| `test_treinta_frames_identicos_generan_una_sola_fila` | PASSED | 16.0 |
| `test_cada_cambio_real_de_diagnostico_se_registra` | PASSED | 16.2 |
| `test_un_diagnostico_repetido_tras_cambiar_se_vuelve_a_registrar` | PASSED | 13.5 |
| `test_las_categorias_se_rastrean_por_separado` | PASSED | 15.7 |
| `test_traduce_la_categoria_interna_a_un_nombre_legible` | PASSED | 19.1 |
| `test_ignora_entradas_que_no_son_diagnosticos_reales[diagnostico0-mensaje vac\xedo (solo dibuja el n\xfamero del \xe1ngulo en pantalla)]` | PASSED | 13.4 |
| `test_ignora_entradas_que_no_son_diagnosticos_reales[diagnostico1-sin categor\xeda]` | PASSED | 13.3 |
| `test_ignora_entradas_que_no_son_diagnosticos_reales[diagnostico2-diccionario incompleto]` | PASSED | 13.7 |
| `test_conserva_angulo_veredicto_y_marca_de_tiempo` | PASSED | 12.0 |
| `test_registra_una_lista_completa_de_diagnosticos_de_un_frame` | PASSED | 12.4 |

### `tests/integration/test_panel_inicio.py`

| Prueba | Estado | Tiempo (ms) |
|---|---|---|
| `test_un_alumno_puede_inscribirse_solo_con_su_nombre` | PASSED | 9.2 |
| `test_la_ficha_completa_se_guarda_y_se_recupera` | PASSED | 9.4 |
| `test_un_alumno_inexistente_devuelve_none_en_vez_de_reventar` | PASSED | 9.5 |
| `test_la_migracion_agrega_la_ficha_a_una_base_que_ya_tenia_alumnos` | PASSED | 17.1 |
| `test_un_dojo_sin_actividad_no_reporta_cero_por_ciento` | PASSED | 10.9 |
| `test_la_ventana_de_actividad_deja_fuera_las_sesiones_viejas` | PASSED | 22.3 |
| `test_los_estados_transitorios_no_alteran_las_metricas_del_panel` | PASSED | 16.9 |
| `test_las_sesiones_recientes_abarcan_a_todo_el_dojo` | PASSED | 11.8 |
| `test_las_sesiones_recientes_respetan_el_limite` | PASSED | 15.7 |
| `test_sin_sesiones_la_lista_viene_vacia_y_no_falla` | PASSED | 7.9 |
| `test_las_tecnicas_se_ordenan_por_cuanto_se_practican` | PASSED | 23.7 |
| `test_las_tecnicas_practicadas_pueden_acotarse_a_la_ventana_reciente` | PASSED | 16.9 |
| `test_el_desempeno_se_separa_por_lado_del_cuerpo` | PASSED | 26.8 |
| `test_los_diagnosticos_sin_lado_no_se_atribuyen_a_ninguno` | PASSED | 18.5 |
| `test_se_cuentan_los_diagnosticos_que_contienen_un_fragmento` | PASSED | 28.3 |
| `test_una_sesion_sin_mediciones_devuelve_ceros_y_no_none` | PASSED | 11.4 |
...
| `test_no_genera_grafica_si_la_sesion_no_dejo_evaluaciones` | PASSED | 223.1 |
| `test_genera_un_png_con_el_historial_de_dos_sesiones` | PASSED | 215.9 |
| `test_crea_la_carpeta_de_evidencias_si_no_existe` | PASSED | 139.7 |
| `test_dos_reportes_seguidos_no_se_sobrescriben` | PASSED | 312.1 |

### `tests/integration/test_umbrales.py`

| Prueba | Estado | Tiempo (ms) |
|---|---|---|
| `test_la_siembra_es_idempotente` | PASSED | 16.5 |
| `test_las_reglas_usan_los_umbrales_de_la_base` | PASSED | 15.2 |
| `test_recalibrar_crea_version_nueva_sin_borrar_la_anterior` | PASSED | 15.4 |
| `test_la_medicion_conserva_el_umbral_que_la_juzgo` | PASSED | 21.3 |
| `test_rechaza_un_maximo_menor_que_el_minimo` | PASSED | 12.2 |
| `test_la_maquina_de_estados_hereda_el_umbral_de_kime` | PASSED | 12.6 |
| `test_sin_base_de_datos_usa_los_valores_de_literatura` | PASSED | 0.4 |
| `test_un_umbral_sin_maximo_no_limita_por_arriba` | PASSED | 0.3 |
| `test_una_correccion_de_literatura_alcanza_a_una_base_ya_sembrada` | PASSED | 15.0 |
| `test_una_correccion_no_pisa_lo_que_el_entrenador_recalibro` | PASSED | 13.3 |
| `test_aplicar_la_correccion_dos_veces_no_crea_versiones_repetidas` | PASSED | 11.9 |
...
| `test_el_lado_se_separa_del_veredicto[DER - TSUKI: EXCELENTE-derecho]` | PASSED | 0.4 |
...
| `test_reduce_la_dispersion_del_ruido` | PASSED | 2.4 |
...
| `test_reconoce_una_camara_de_red[https://camara.dojo.local/stream]` | PASSED | 0.4 |
| `test_reconoce_una_camara_de_red[rtsp://192.168.0.10:554/live]` | PASSED | 0.4 |
...
| `test_una_fuente_ininteligible_se_rechaza_con_un_mensaje_util[None]` | PASSED | 0.4 |
...
| `test_calcula_el_angulo_interno_conocido[tsuki en rango correcto-a3-b3-c3-170.3]` | PASSED | 0.7 |
...
| `test_mae_geri_rechaza_extension_lenta[200]` | PASSED | 0.5 |
| `test_mae_geri_rechaza_extension_lenta[399.9]` | PASSED | 0.5 |
...
| `test_el_nombre_de_linux_se_limpia[-None]` | PASSED | 0.4 |
...
| `test_el_angulo_se_redondea_a_grados_enteros[169.6-170\xb0]` | PASSED | 0.4 |
| `test_el_angulo_se_redondea_a_grados_enteros[0.0-0\xb0]` | PASSED | 0.5 |
...
| `test_el_veredicto_es_binario_y_no_un_puntaje[None-\u2014]` | PASSED | 0.4 |
...
| `test_una_edad_imposible_se_explica_en_lugar_de_guardarse[-4-entre 3 y 99]` | PASSED | 0.6 |
| `test_el_peso_admite_coma_decimal[62.5-62.5]` | PASSED | 0.5 |
| `test_el_peso_admite_coma_decimal[62,5-62.5]` | PASSED | 0.6 |
