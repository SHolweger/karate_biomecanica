...
| **Fecha y hora de inicio** | 2026-09-14 17:35:22 |
| **Duración total** | 2.49 s |
...
|---|---|---|---|---|---|
| Unitaria | 254 | 254 | 0 | 0 | 0.09 |
| Integración | 130 | 130 | 0 | 0 | 2.08 |
| **Total** | **384** | **384** | **0** | **0** | **2.17** |
...
| `test_el_angulo_medido_coincide_con_la_pose_ejecutada` | PASSED | 0.4 |
...
| `test_identifica_la_postura_antes_de_evaluarla[postura adelantada-100-170-ZENKUTSU]` | PASSED | 0.9 |
| `test_identifica_la_postura_antes_de_evaluarla[postura atrasada-165-105-KOKUTSU]` | PASSED | 1.2 |
| `test_la_guardia_se_deduce_de_la_profundidad_de_los_tobillos` | PASSED | 0.5 |
| `test_una_transicion_no_se_califica_como_error` | PASSED | 0.5 |
| `test_kiba_dachi_mal_ejecutado_se_detecta_pero_se_corrige` | PASSED | 0.7 |
...
| Prueba | Estado | Tiempo (ms) |
|---|---|---|
| `test_el_primer_uso_registra_al_entrenador_principal` | PASSED | 13.1 |
| `test_login_exitoso_de_un_entrenador_existente` | PASSED | 11.1 |
| `test_reintento_tras_una_contrasena_equivocada` | PASSED | 11.1 |
| `test_tras_fallar_puede_crear_una_cuenta_de_sensei_asistente` | PASSED | 10.4 |
| `test_elegir_un_perfil_existente_de_la_lista` | PASSED | 10.9 |
| `test_crear_un_perfil_nuevo_desde_la_lista` | PASSED | 11.8 |
| `test_el_grado_del_cinturon_es_opcional` | PASSED | 11.0 |
| `test_una_opcion_invalida_vuelve_a_preguntar[abc-texto en vez de n\xfamero]` | PASSED | 11.2 |
| `test_una_opcion_invalida_vuelve_a_preguntar[0-n\xfamero fuera de rango por abajo]` | PASSED | 10.7 |
| `test_una_opcion_invalida_vuelve_a_preguntar[99-n\xfamero fuera de rango por arriba]` | PASSED | 10.5 |

### `tests/integration/test_configuracion.py`

| Prueba | Estado | Tiempo (ms) |
|---|---|---|
| `test_una_preferencia_no_configurada_devuelve_el_valor_por_defecto` | PASSED | 8.3 |
| `test_la_preferencia_sobrevive_al_reinicio_del_sistema` | PASSED | 9.7 |
| `test_reconfigurar_reemplaza_en_vez_de_duplicar` | PASSED | 9.6 |
| `test_los_valores_se_guardan_como_texto` | PASSED | 9.6 |
| `test_la_migracion_no_toca_una_base_ya_existente` | PASSED | 11.8 |

### `tests/integration/test_consultas_progreso.py`

| Prueba | Estado | Tiempo (ms) |
|---|---|---|
| `test_la_precision_ignora_los_estados_transitorios` | PASSED | 20.8 |
| `test_un_alumno_sin_mediciones_aparece_con_precision_desconocida` | PASSED | 19.6 |
| `test_todos_los_alumnos_aparecen_aunque_no_hayan_entrenado` | PASSED | 20.3 |
| `test_las_sesiones_se_listan_de_la_mas_reciente_a_la_mas_antigua` | PASSED | 21.2 |
| `test_cada_sesion_trae_su_propia_precision` | PASSED | 19.3 |
| `test_una_sesion_abierta_se_distingue_de_una_cerrada` | PASSED | 19.6 |
| `test_un_alumno_sin_sesiones_devuelve_lista_vacia` | PASSED | 25.4 |
| `test_las_tecnicas_se_ordenan_de_la_mas_floja_a_la_mas_solida` | PASSED | 22.7 |
| `test_el_desempeno_puede_acotarse_a_una_sola_sesion` | PASSED | 20.1 |
| `test_el_angulo_medio_se_promedia_por_tecnica` | PASSED | 20.1 |
| `test_el_detalle_de_sesion_identifica_al_alumno_y_al_entrenador` | PASSED | 19.9 |
| `test_una_sesion_inexistente_devuelve_none` | PASSED | 19.9 |
| `test_los_errores_se_agrupan_y_ordenan_por_frecuencia` | PASSED | 18.1 |
| `test_una_sesion_sin_errores_no_reporta_correcciones` | PASSED | 19.6 |

### `tests/integration/test_database.py`

| Prueba | Estado | Tiempo (ms) |
|---|---|---|
| `test_primer_arranque_no_tiene_entrenadores` | PASSED | 6.9 |
| `test_registro_y_autenticacion_exitosa` | PASSED | 8.3 |
| `test_credenciales_invalidas_no_dan_acceso[sholweger-clave_incorrecta-contrase\xf1a equivocada]` | PASSED | 12.3 |
| `test_credenciales_invalidas_no_dan_acceso[usuario_inexistente-clave123-usuario que no existe]` | PASSED | 9.5 |
| `test_credenciales_invalidas_no_dan_acceso[SHOLWEGER-clave123-usuario con distinta capitalizaci\xf3n]` | PASSED | 10.3 |
| `test_credenciales_invalidas_no_dan_acceso[--credenciales vac\xedas]` | PASSED | 8.5 |
| `test_la_contrasena_nunca_se_guarda_en_texto_plano` | PASSED | 8.8 |
| `test_no_se_permiten_dos_entrenadores_con_el_mismo_usuario` | PASSED | 9.4 |
| `test_el_rol_por_defecto_es_sensei` | PASSED | 10.3 |
| `test_los_atletas_se_listan_alfabeticamente` | PASSED | 12.1 |
| `test_crear_atleta_devuelve_un_identificador_utilizable` | PASSED | 10.5 |
| `test_los_datos_opcionales_del_atleta_pueden_omitirse` | PASSED | 10.4 |
| `test_una_sesion_abierta_no_tiene_hora_de_fin` | PASSED | 12.1 |
| `test_cerrar_sesion_registra_la_hora_de_fin` | PASSED | 11.9 |
| `test_la_sesion_queda_ligada_al_atleta_y_al_entrenador` | PASSED | 15.2 |
| `test_guardar_y_recuperar_una_medicion` | PASSED | 14.4 |
| `test_el_veredicto_se_persiste_en_los_tres_estados[True-1]` | PASSED | 15.5 |
| `test_el_veredicto_se_persiste_en_los_tres_estados[False-0]` | PASSED | 15.8 |
| `test_el_veredicto_se_persiste_en_los_tres_estados[None-None]` | PASSED | 17.6 |
| `test_el_historial_solo_devuelve_las_mediciones_del_atleta_consultado` | PASSED | 19.9 |
| `test_un_atleta_sin_entrenamientos_tiene_historial_vacio` | PASSED | 10.0 |
| `test_las_mediciones_sobreviven_al_cierre_de_la_aplicacion` | PASSED | 14.6 |
| `test_migra_una_base_de_datos_creada_sin_la_columna_correcto` | PASSED | 11.9 |
...
| Prueba | Estado | Tiempo (ms) |
|---|---|---|
| `test_treinta_frames_identicos_generan_una_sola_fila` | PASSED | 10.9 |
| `test_cada_cambio_real_de_diagnostico_se_registra` | PASSED | 13.9 |
| `test_un_diagnostico_repetido_tras_cambiar_se_vuelve_a_registrar` | PASSED | 12.9 |
| `test_las_categorias_se_rastrean_por_separado` | PASSED | 13.4 |
| `test_traduce_la_categoria_interna_a_un_nombre_legible` | PASSED | 17.3 |
| `test_ignora_entradas_que_no_son_diagnosticos_reales[diagnostico0-mensaje vac\xedo (solo dibuja el n\xfamero del \xe1ngulo en pantalla)]` | PASSED | 10.7 |
| `test_ignora_entradas_que_no_son_diagnosticos_reales[diagnostico1-sin categor\xeda]` | PASSED | 12.0 |
| `test_ignora_entradas_que_no_son_diagnosticos_reales[diagnostico2-diccionario incompleto]` | PASSED | 12.5 |
| `test_conserva_angulo_veredicto_y_marca_de_tiempo` | PASSED | 12.3 |
| `test_registra_una_lista_completa_de_diagnosticos_de_un_frame` | PASSED | 12.5 |

### `tests/integration/test_panel_inicio.py`

| Prueba | Estado | Tiempo (ms) |
|---|---|---|
| `test_un_alumno_puede_inscribirse_solo_con_su_nombre` | PASSED | 9.4 |
| `test_la_ficha_completa_se_guarda_y_se_recupera` | PASSED | 11.9 |
| `test_un_alumno_inexistente_devuelve_none_en_vez_de_reventar` | PASSED | 8.6 |
| `test_la_migracion_agrega_la_ficha_a_una_base_que_ya_tenia_alumnos` | PASSED | 16.2 |
| `test_un_dojo_sin_actividad_no_reporta_cero_por_ciento` | PASSED | 9.2 |
| `test_la_ventana_de_actividad_deja_fuera_las_sesiones_viejas` | PASSED | 21.2 |
| `test_los_estados_transitorios_no_alteran_las_metricas_del_panel` | PASSED | 18.7 |
| `test_las_sesiones_recientes_abarcan_a_todo_el_dojo` | PASSED | 12.5 |
| `test_las_sesiones_recientes_respetan_el_limite` | PASSED | 15.2 |
| `test_sin_sesiones_la_lista_viene_vacia_y_no_falla` | PASSED | 8.8 |
| `test_las_tecnicas_se_ordenan_por_cuanto_se_practican` | PASSED | 23.2 |
| `test_las_tecnicas_practicadas_pueden_acotarse_a_la_ventana_reciente` | PASSED | 15.1 |
...
| `test_no_genera_grafica_si_la_sesion_no_dejo_evaluaciones` | PASSED | 217.2 |
| `test_genera_un_png_con_el_historial_de_dos_sesiones` | PASSED | 247.7 |
| `test_crea_la_carpeta_de_evidencias_si_no_existe` | PASSED | 164.2 |
| `test_dos_reportes_seguidos_no_se_sobrescriben` | PASSED | 286.2 |

### `tests/integration/test_umbrales.py`

| Prueba | Estado | Tiempo (ms) |
|---|---|---|
| `test_la_siembra_es_idempotente` | PASSED | 16.1 |
| `test_las_reglas_usan_los_umbrales_de_la_base` | PASSED | 11.3 |
| `test_recalibrar_crea_version_nueva_sin_borrar_la_anterior` | PASSED | 13.1 |
| `test_la_medicion_conserva_el_umbral_que_la_juzgo` | PASSED | 18.3 |
| `test_rechaza_un_maximo_menor_que_el_minimo` | PASSED | 11.8 |
| `test_la_maquina_de_estados_hereda_el_umbral_de_kime` | PASSED | 13.3 |
| `test_sin_base_de_datos_usa_los_valores_de_literatura` | PASSED | 0.2 |
| `test_un_umbral_sin_maximo_no_limita_por_arriba` | PASSED | 0.2 |
| `test_una_correccion_de_literatura_alcanza_a_una_base_ya_sembrada` | PASSED | 13.5 |
| `test_una_correccion_no_pisa_lo_que_el_entrenador_recalibro` | PASSED | 11.1 |
| `test_aplicar_la_correccion_dos_veces_no_crea_versiones_repetidas` | PASSED | 12.9 |
...
| `test_reconoce_una_camara_de_red[HTTP://192.168.1.50:8080/video]` | PASSED | 0.5 |
...
| `test_no_confunde_un_dispositivo_local_con_una_direccion[]` | PASSED | 0.4 |
...
| `test_una_fuente_ininteligible_se_rechaza_con_un_mensaje_util[\xedndice dos]` | PASSED | 2.4 |
...
| `test_zenkutsu_dachi_distingue_pierna_delantera_de_trasera[115-180-True]` | PASSED | 0.6 |
...
| `test_age_uke_bloquea_solo_en_su_rango[120.0-True-EFECTIVO]` | PASSED | 0.6 |
...
| `test_el_tiempo_se_lee_como_un_cronometro[1000-00:01]` | PASSED | 0.4 |
...
| `test_un_fotograma_sin_persona_no_rompe_el_feed` | PASSED | 0.3 |
...
| `test_los_pasos_admiten_tuplas_ademas_de_objetos_paso` | PASSED | 0.4 |
...
| `test_rechaza_un_identificador_fuera_del_patron[]` | PASSED | 0.5 |
...
| `test_el_decorador_impide_que_dos_pruebas_reclamen_el_mismo_id` | PASSED | 0.6 |
| `test_el_decorador_cuelga_la_ficha_sin_envolver_la_funcion` | PASSED | 0.2 |
| `test_un_hueco_real_es_incumplimiento_en_una_corrida_completa` | PASSED | 0.4 |
...
| `test_el_grado_se_pide_desde_la_cinta_cafe[Negra]` | PASSED | 0.5 |
| `test_en_los_colores_iniciales_el_color_ya_determina_el_kyu[Blanca]` | PASSED | 0.5 |
...
| `test_el_valor_mostrado_es_legible_para_el_entrenador[160.5-160.5]` | PASSED | 0.5 |
