...
| **Fecha y hora de inicio** | 2026-09-14 18:59:09 |
| **Duración total** | 2.82 s |
...
|---|---|---|---|---|---|
| Unitaria | 295 | 295 | 0 | 0 | 0.11 |
| Integración | 134 | 134 | 0 | 0 | 2.34 |
| **Total** | **429** | **429** | **0** | **0** | **2.45** |
...
|---|---|---|
| `test_evalua_los_dos_brazos_de_forma_independiente` | PASSED | 0.7 |
...
| Prueba | Estado | Tiempo (ms) |
|---|---|---|
| `test_el_primer_uso_registra_al_entrenador_principal` | PASSED | 21.5 |
| `test_login_exitoso_de_un_entrenador_existente` | PASSED | 12.4 |
| `test_reintento_tras_una_contrasena_equivocada` | PASSED | 9.1 |
| `test_tras_fallar_puede_crear_una_cuenta_de_sensei_asistente` | PASSED | 9.9 |
| `test_elegir_un_perfil_existente_de_la_lista` | PASSED | 13.4 |
| `test_crear_un_perfil_nuevo_desde_la_lista` | PASSED | 11.2 |
| `test_el_grado_del_cinturon_es_opcional` | PASSED | 9.9 |
| `test_una_opcion_invalida_vuelve_a_preguntar[abc-texto en vez de n\xfamero]` | PASSED | 9.3 |
| `test_una_opcion_invalida_vuelve_a_preguntar[0-n\xfamero fuera de rango por abajo]` | PASSED | 8.7 |
| `test_una_opcion_invalida_vuelve_a_preguntar[99-n\xfamero fuera de rango por arriba]` | PASSED | 8.3 |

### `tests/integration/test_configuracion.py`

| Prueba | Estado | Tiempo (ms) |
|---|---|---|
| `test_una_preferencia_no_configurada_devuelve_el_valor_por_defecto` | PASSED | 6.9 |
| `test_la_preferencia_sobrevive_al_reinicio_del_sistema` | PASSED | 8.5 |
| `test_reconfigurar_reemplaza_en_vez_de_duplicar` | PASSED | 10.0 |
| `test_los_valores_se_guardan_como_texto` | PASSED | 8.5 |
| `test_la_migracion_no_toca_una_base_ya_existente` | PASSED | 8.9 |

### `tests/integration/test_consultas_progreso.py`

| Prueba | Estado | Tiempo (ms) |
|---|---|---|
| `test_la_precision_ignora_los_estados_transitorios` | PASSED | 17.8 |
| `test_un_alumno_sin_mediciones_aparece_con_precision_desconocida` | PASSED | 17.8 |
| `test_todos_los_alumnos_aparecen_aunque_no_hayan_entrenado` | PASSED | 18.8 |
| `test_las_sesiones_se_listan_de_la_mas_reciente_a_la_mas_antigua` | PASSED | 17.0 |
| `test_cada_sesion_trae_su_propia_precision` | PASSED | 24.2 |
| `test_una_sesion_abierta_se_distingue_de_una_cerrada` | PASSED | 22.7 |
| `test_un_alumno_sin_sesiones_devuelve_lista_vacia` | PASSED | 20.2 |
| `test_las_tecnicas_se_ordenan_de_la_mas_floja_a_la_mas_solida` | PASSED | 25.1 |
| `test_el_desempeno_puede_acotarse_a_una_sola_sesion` | PASSED | 29.6 |
| `test_el_angulo_medio_se_promedia_por_tecnica` | PASSED | 19.0 |
| `test_el_detalle_de_sesion_identifica_al_alumno_y_al_entrenador` | PASSED | 19.2 |
| `test_una_sesion_inexistente_devuelve_none` | PASSED | 17.9 |
| `test_los_errores_se_agrupan_y_ordenan_por_frecuencia` | PASSED | 17.0 |
| `test_una_sesion_sin_errores_no_reporta_correcciones` | PASSED | 18.8 |

### `tests/integration/test_database.py`

| Prueba | Estado | Tiempo (ms) |
|---|---|---|
| `test_primer_arranque_no_tiene_entrenadores` | PASSED | 7.7 |
| `test_registro_y_autenticacion_exitosa` | PASSED | 7.9 |
| `test_credenciales_invalidas_no_dan_acceso[sholweger-clave_incorrecta-contrase\xf1a equivocada]` | PASSED | 11.4 |
| `test_credenciales_invalidas_no_dan_acceso[usuario_inexistente-clave123-usuario que no existe]` | PASSED | 10.2 |
| `test_credenciales_invalidas_no_dan_acceso[SHOLWEGER-clave123-usuario con distinta capitalizaci\xf3n]` | PASSED | 10.7 |
| `test_credenciales_invalidas_no_dan_acceso[--credenciales vac\xedas]` | PASSED | 14.9 |
| `test_la_contrasena_nunca_se_guarda_en_texto_plano` | PASSED | 11.3 |
| `test_no_se_permiten_dos_entrenadores_con_el_mismo_usuario` | PASSED | 13.2 |
| `test_el_rol_por_defecto_es_sensei` | PASSED | 12.7 |
| `test_los_atletas_se_listan_alfabeticamente` | PASSED | 18.4 |
| `test_crear_atleta_devuelve_un_identificador_utilizable` | PASSED | 11.8 |
| `test_los_datos_opcionales_del_atleta_pueden_omitirse` | PASSED | 13.0 |
| `test_una_sesion_abierta_no_tiene_hora_de_fin` | PASSED | 17.4 |
| `test_cerrar_sesion_registra_la_hora_de_fin` | PASSED | 15.2 |
| `test_la_sesion_queda_ligada_al_atleta_y_al_entrenador` | PASSED | 14.0 |
| `test_guardar_y_recuperar_una_medicion` | PASSED | 13.7 |
| `test_el_veredicto_se_persiste_en_los_tres_estados[True-1]` | PASSED | 16.6 |
| `test_el_veredicto_se_persiste_en_los_tres_estados[False-0]` | PASSED | 13.0 |
| `test_el_veredicto_se_persiste_en_los_tres_estados[None-None]` | PASSED | 13.3 |
| `test_el_historial_solo_devuelve_las_mediciones_del_atleta_consultado` | PASSED | 17.6 |
| `test_un_atleta_sin_entrenamientos_tiene_historial_vacio` | PASSED | 10.3 |
| `test_las_mediciones_sobreviven_al_cierre_de_la_aplicacion` | PASSED | 12.1 |
| `test_migra_una_base_de_datos_creada_sin_la_columna_correcto` | PASSED | 12.6 |
| `test_abrir_dos_veces_la_misma_base_no_duplica_el_esquema` | PASSED | 7.7 |
...
| Prueba | Estado | Tiempo (ms) |
|---|---|---|
| `test_treinta_frames_identicos_generan_una_sola_fila` | PASSED | 13.2 |
| `test_cada_cambio_real_de_diagnostico_se_registra` | PASSED | 12.1 |
| `test_un_diagnostico_repetido_tras_cambiar_se_vuelve_a_registrar` | PASSED | 11.0 |
| `test_las_categorias_se_rastrean_por_separado` | PASSED | 13.2 |
| `test_traduce_la_categoria_interna_a_un_nombre_legible` | PASSED | 14.2 |
| `test_ignora_entradas_que_no_son_diagnosticos_reales[diagnostico0-mensaje vac\xedo (solo dibuja el n\xfamero del \xe1ngulo en pantalla)]` | PASSED | 12.6 |
| `test_ignora_entradas_que_no_son_diagnosticos_reales[diagnostico1-sin categor\xeda]` | PASSED | 11.6 |
| `test_ignora_entradas_que_no_son_diagnosticos_reales[diagnostico2-diccionario incompleto]` | PASSED | 9.7 |
| `test_conserva_angulo_veredicto_y_marca_de_tiempo` | PASSED | 10.4 |
| `test_registra_una_lista_completa_de_diagnosticos_de_un_frame` | PASSED | 9.7 |

### `tests/integration/test_panel_inicio.py`

| Prueba | Estado | Tiempo (ms) |
|---|---|---|
| `test_un_alumno_puede_inscribirse_solo_con_su_nombre` | PASSED | 7.6 |
| `test_la_ficha_completa_se_guarda_y_se_recupera` | PASSED | 8.0 |
| `test_un_alumno_inexistente_devuelve_none_en_vez_de_reventar` | PASSED | 9.8 |
| `test_la_migracion_agrega_la_ficha_a_una_base_que_ya_tenia_alumnos` | PASSED | 17.2 |
| `test_un_dojo_sin_actividad_no_reporta_cero_por_ciento` | PASSED | 10.5 |
| `test_la_ventana_de_actividad_deja_fuera_las_sesiones_viejas` | PASSED | 26.9 |
| `test_los_estados_transitorios_no_alteran_las_metricas_del_panel` | PASSED | 17.0 |
| `test_las_sesiones_recientes_abarcan_a_todo_el_dojo` | PASSED | 12.1 |
| `test_las_sesiones_recientes_respetan_el_limite` | PASSED | 14.3 |
| `test_sin_sesiones_la_lista_viene_vacia_y_no_falla` | PASSED | 7.1 |
| `test_las_tecnicas_se_ordenan_por_cuanto_se_practican` | PASSED | 20.7 |
| `test_las_tecnicas_practicadas_pueden_acotarse_a_la_ventana_reciente` | PASSED | 17.8 |
| `test_el_desempeno_se_separa_por_lado_del_cuerpo` | PASSED | 40.1 |
| `test_los_diagnosticos_sin_lado_no_se_atribuyen_a_ninguno` | PASSED | 22.2 |
| `test_se_cuentan_los_diagnosticos_que_contienen_un_fragmento` | PASSED | 24.7 |
| `test_una_sesion_sin_mediciones_devuelve_ceros_y_no_none` | PASSED | 11.2 |
...
| `test_no_genera_grafica_si_la_sesion_no_dejo_evaluaciones` | PASSED | 237.9 |
| `test_genera_un_png_con_el_historial_de_dos_sesiones` | PASSED | 280.4 |
| `test_crea_la_carpeta_de_evidencias_si_no_existe` | PASSED | 201.1 |
| `test_dos_reportes_seguidos_no_se_sobrescriben` | PASSED | 370.6 |

### `tests/integration/test_umbrales.py`

| Prueba | Estado | Tiempo (ms) |
|---|---|---|
| `test_la_siembra_es_idempotente` | PASSED | 11.9 |
| `test_las_reglas_usan_los_umbrales_de_la_base` | PASSED | 11.1 |
| `test_recalibrar_crea_version_nueva_sin_borrar_la_anterior` | PASSED | 11.0 |
| `test_la_medicion_conserva_el_umbral_que_la_juzgo` | PASSED | 14.5 |
| `test_rechaza_un_maximo_menor_que_el_minimo` | PASSED | 10.1 |
...
| `test_una_correccion_de_literatura_alcanza_a_una_base_ya_sembrada` | PASSED | 12.1 |
| `test_una_correccion_no_pisa_lo_que_el_entrenador_recalibro` | PASSED | 11.6 |
| `test_aplicar_la_correccion_dos_veces_no_crea_versiones_repetidas` | PASSED | 10.1 |
...
| `test_el_lado_se_separa_del_veredicto[IZQ - TSUKI: EXCELENTE-izquierdo]` | PASSED | 0.5 |
...
| `test_ventana_de_uno_no_suaviza` | PASSED | 0.4 |
...
| `test_no_confunde_un_dispositivo_local_con_una_direccion[]` | PASSED | 0.3 |
...
| `test_los_indices_se_convierten_a_entero[2-2_1]` | PASSED | 0.4 |
...
| `test_calcula_el_angulo_interno_conocido[brazo plegado-a2-b2-c2-0.0]` | PASSED | 0.5 |
| `test_calcula_el_angulo_interno_conocido[tsuki en rango correcto-a3-b3-c3-170.3]` | PASSED | 0.5 |
| `test_calcula_el_angulo_interno_conocido[angulo agudo de 45-a4-b4-c4-45.0]` | PASSED | 0.6 |
| `test_reconstruye_cualquier_angulo_del_rango_articular[0]` | PASSED | 0.4 |
| `test_reconstruye_cualquier_angulo_del_rango_articular[15]` | PASSED | 0.4 |
| `test_reconstruye_cualquier_angulo_del_rango_articular[30]` | PASSED | 0.3 |
| `test_reconstruye_cualquier_angulo_del_rango_articular[45]` | PASSED | 0.4 |
| `test_reconstruye_cualquier_angulo_del_rango_articular[60]` | PASSED | 0.4 |
| `test_reconstruye_cualquier_angulo_del_rango_articular[90]` | PASSED | 0.3 |
| `test_reconstruye_cualquier_angulo_del_rango_articular[120]` | PASSED | 0.4 |
...
| `test_tsuki_correcto_dentro_del_rango_de_kime[170]` | PASSED | 0.5 |
| `test_tsuki_correcto_dentro_del_rango_de_kime[175]` | PASSED | 0.5 |
...
| `test_tsuki_flexionado_no_alcanza_el_kime[0]` | PASSED | 0.5 |
...
| `test_tsuki_fronteras_exactas[160.0-True]` | PASSED | 0.5 |
| `test_tsuki_fronteras_exactas[175.0-True]` | PASSED | 0.5 |
...
| `test_heiko_dachi_exige_rodillas_extendidas[172.0-True]` | PASSED | 0.6 |
...
| `test_kiba_dachi_exige_simetria_en_ambas_rodillas[130-150-True]` | PASSED | 0.5 |
| `test_kiba_dachi_exige_simetria_en_ambas_rodillas[129-140-False]` | PASSED | 0.6 |
| `test_kiba_dachi_exige_simetria_en_ambas_rodillas[140-151-False]` | PASSED | 0.5 |
...
| `test_zenkutsu_dachi_distingue_pierna_delantera_de_trasera[120-170-False]` | PASSED | 0.6 |
| `test_zenkutsu_dachi_distingue_pierna_delantera_de_trasera[100-160-False]` | PASSED | 0.5 |
| `test_kokutsu_dachi_carga_el_peso_en_la_pierna_trasera[160-105-True]` | PASSED | 0.5 |
| `test_kokutsu_dachi_carga_el_peso_en_la_pierna_trasera[145-90-True]` | PASSED | 0.6 |
| `test_kokutsu_dachi_carga_el_peso_en_la_pierna_trasera[175-120-True]` | PASSED | 0.5 |
| `test_kokutsu_dachi_carga_el_peso_en_la_pierna_trasera[130-105-False]` | PASSED | 0.5 |
| `test_kokutsu_dachi_carga_el_peso_en_la_pierna_trasera[160-140-False]` | PASSED | 0.4 |
| `test_kokutsu_dachi_carga_el_peso_en_la_pierna_trasera[110-100-False]` | PASSED | 0.5 |
| `test_zenkutsu_y_kokutsu_no_aprueban_la_misma_ejecucion` | PASSED | 0.5 |
| `test_mae_geri_excelente_con_kime_y_explosividad` | PASSED | 0.4 |
| `test_mae_geri_rechaza_kime_incompleto_aunque_sea_veloz[159.9-900]` | PASSED | 0.5 |
...
| `test_hikiashi_evalua_el_recojo_de_la_pierna[False-False]` | PASSED | 0.5 |
...
| `test_age_uke_bloquea_solo_en_su_rango[140.1-False-DEMASIADO EXTENDIDO]` | PASSED | 0.5 |
| `test_toda_regla_devuelve_el_contrato_esperado[evaluate_tsuki-argumentos0]` | PASSED | 0.4 |
| `test_toda_regla_devuelve_el_contrato_esperado[evaluate_heiko_dachi-argumentos1]` | PASSED | 0.5 |
| `test_toda_regla_devuelve_el_contrato_esperado[evaluate_kiba_dachi-argumentos2]` | PASSED | 0.5 |
| `test_toda_regla_devuelve_el_contrato_esperado[evaluate_zenkutsu_dachi-argumentos3]` | PASSED | 0.5 |
...
| `test_una_respuesta_ilegible_no_produce_nombres_ni_excepciones[]` | PASSED | 0.5 |
| `test_una_respuesta_ilegible_no_produce_nombres_ni_excepciones[   ]` | PASSED | 0.3 |
| `test_una_respuesta_ilegible_no_produce_nombres_ni_excepciones[no es json]` | PASSED | 0.4 |
...
| `test_el_nombre_de_linux_se_limpia[None-None]` | PASSED | 0.3 |
...
| `test_el_tiempo_se_lee_como_un_cronometro[24000-00:24]` | PASSED | 0.4 |
| `test_el_tiempo_se_lee_como_un_cronometro[59999-00:59]` | PASSED | 0.4 |
| `test_el_tiempo_se_lee_como_un_cronometro[60000-01:00]` | PASSED | 0.4 |
| `test_el_tiempo_se_lee_como_un_cronometro[605000-10:05]` | PASSED | 0.4 |
...
| `test_el_angulo_se_redondea_a_grados_enteros[170.4-170\xb0]` | PASSED | 0.4 |
...
| `test_el_veredicto_es_binario_y_no_un_puntaje[True-Correcto]` | PASSED | 0.4 |
| `test_el_veredicto_es_binario_y_no_un_puntaje[False-Incorrecto]` | PASSED | 0.4 |
| `test_el_veredicto_es_binario_y_no_un_puntaje[None-\u2014]` | PASSED | 0.3 |
| `test_las_articulaciones_se_muestran_siempre_en_el_mismo_orden` | PASSED | 0.3 |
...
| `test_rechaza_un_identificador_fuera_del_patron[TC-001]` | PASSED | 0.5 |
...
| `test_exige_al_menos_una_asercion_explicita` | PASSED | 0.3 |
...
| `test_el_decorador_cuelga_la_ficha_sin_envolver_la_funcion` | PASSED | 0.3 |
| `test_un_hueco_real_es_incumplimiento_en_una_corrida_completa` | PASSED | 0.3 |
| `test_un_hueco_por_modulos_omitidos_es_solo_un_aviso` | PASSED | 0.4 |
...
| Prueba | Estado | Tiempo (ms) |
|---|---|---|
| `test_la_linea_de_comandos_elige_la_via_correcta[argumentos0-grafico]` | PASSED | 0.8 |
| `test_la_linea_de_comandos_elige_la_via_correcta[argumentos1-consola]` | PASSED | 0.7 |
| `test_si_falta_una_dependencia_grafica_se_explica_como_seguir` | PASSED | 0.8 |
...
| `test_en_los_colores_iniciales_el_color_ya_determina_el_kyu[Amarilla]` | PASSED | 0.4 |
...
| `test_en_los_colores_iniciales_el_color_ya_determina_el_kyu[Azul]` | PASSED | 0.3 |
...
| `test_el_nombre_es_el_unico_campo_obligatorio[]` | PASSED | 1.8 |
...
| `test_la_edad_se_interpreta_o_queda_vacia[  8 -8]` | PASSED | 0.4 |
| `test_la_edad_se_interpreta_o_queda_vacia[-None]` | PASSED | 0.4 |
| `test_la_edad_se_interpreta_o_queda_vacia[   -None]` | PASSED | 0.5 |
| `test_una_edad_imposible_se_explica_en_lugar_de_guardarse[diecis\xe9is-no es un n\xfamero]` | PASSED | 0.6 |
| `test_una_edad_imposible_se_explica_en_lugar_de_guardarse[16.5-no es un n\xfamero]` | PASSED | 0.4 |
| `test_una_edad_imposible_se_explica_en_lugar_de_guardarse[2-entre 3 y 99]` | PASSED | 0.5 |
| `test_una_edad_imposible_se_explica_en_lugar_de_guardarse[150-entre 3 y 99]` | PASSED | 0.4 |
| `test_una_edad_imposible_se_explica_en_lugar_de_guardarse[-4-entre 3 y 99]` | PASSED | 0.5 |
| `test_el_peso_admite_coma_decimal[62.5-62.5]` | PASSED | 0.4 |
| `test_el_peso_admite_coma_decimal[62,5-62.5]` | PASSED | 0.4 |
| `test_el_peso_admite_coma_decimal[ 70 -70.0]` | PASSED | 0.4 |
| `test_el_peso_admite_coma_decimal[-None]` | PASSED | 0.4 |
| `test_un_peso_imposible_se_explica[sesenta-no es un n\xfamero]` | PASSED | 0.4 |
| `test_un_peso_imposible_se_explica[5-entre 10 y 250]` | PASSED | 0.5 |
| `test_un_peso_imposible_se_explica[400-entre 10 y 250]` | PASSED | 0.4 |
...
| `test_una_hiperextension_frecuente_se_reporta_como_riesgo` | PASSED | 0.3 |
...
| `test_sin_evaluaciones_no_se_afirma_nada` | PASSED | 0.3 |
| `test_la_asimetria_exige_repeticiones_suficientes_en_ambos_lados` | PASSED | 0.3 |
| `test_un_solo_lado_con_pocas_repeticiones_basta_para_callar` | PASSED | 0.3 |
| `test_una_diferencia_dentro_de_lo_normal_no_se_reporta` | PASSED | 0.3 |
| `test_la_asimetria_se_detecta_en_cualquier_direccion` | PASSED | 0.3 |
...
| `test_los_hallazgos_se_ordenan_del_mas_urgente_al_informativo` | PASSED | 0.3 |
...
| `test_acepta_las_formas_validas_de_escribir_un_rango[160,5-175-esperado2]` | PASSED | 0.4 |
| `test_acepta_las_formas_validas_de_escribir_un_rango[  160 - 175 -esperado3]` | PASSED | 0.3 |
| `test_acepta_las_formas_validas_de_escribir_un_rango[0-180-esperado4]` | PASSED | 0.6 |
...
| `test_un_maximo_vacio_significa_sin_limite_superior[-]` | PASSED | 0.3 |
| `test_un_maximo_vacio_significa_sin_limite_superior[\u2014]` | PASSED | 0.5 |
| `test_un_maximo_vacio_significa_sin_limite_superior[sin l\xedmite]` | PASSED | 0.3 |
| `test_un_maximo_vacio_significa_sin_limite_superior[Sin Limite]` | PASSED | 0.4 |
...
| `test_rechaza_los_rangos_imposibles[-175-m\xednimo es obligatorio]` | PASSED | 0.4 |
| `test_rechaza_los_rangos_imposibles[ciento sesenta-175-no es un n\xfamero]` | PASSED | 0.5 |
| `test_rechaza_los_rangos_imposibles[175-160-no puede ser menor]` | PASSED | 0.5 |
| `test_rechaza_los_rangos_imposibles[-5-10-no puede ser negativo]` | PASSED | 0.5 |
...
| `test_el_valor_mostrado_es_legible_para_el_entrenador[None-sin l\xedmite]` | PASSED | 0.7 |
