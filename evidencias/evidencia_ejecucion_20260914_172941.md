...
| **Fecha y hora de inicio** | 2026-09-14 17:29:41 |
| **Duración total** | 2.46 s |
| **Entorno de ejecución** | Linux 6.18.44-fc-v24 (x86_64) |
| **Intérprete** | Python 3.11.15 |
| **Rama / commit** | `pruebas-automatizadas-4xi06f` @ `4514808` (con cambios sin confirmar) |
| **Pruebas recolectadas** | 384 |
...
|---|---|---|---|---|---|
| Unitaria | 254 | 254 | 0 | 0 | 0.08 |
| Integración | 130 | 130 | 0 | 0 | 1.99 |
| **Total** | **384** | **384** | **0** | **0** | **2.07** |
...
| `test_el_filtro_se_reinicia_cuando_el_brazo_desaparece` | PASSED | 0.5 |
...
| Prueba | Estado | Tiempo (ms) |
|---|---|---|
| `test_el_primer_uso_registra_al_entrenador_principal` | PASSED | 10.6 |
| `test_login_exitoso_de_un_entrenador_existente` | PASSED | 7.8 |
| `test_reintento_tras_una_contrasena_equivocada` | PASSED | 8.1 |
| `test_tras_fallar_puede_crear_una_cuenta_de_sensei_asistente` | PASSED | 10.4 |
| `test_elegir_un_perfil_existente_de_la_lista` | PASSED | 9.4 |
| `test_crear_un_perfil_nuevo_desde_la_lista` | PASSED | 10.1 |
| `test_el_grado_del_cinturon_es_opcional` | PASSED | 7.0 |
| `test_una_opcion_invalida_vuelve_a_preguntar[abc-texto en vez de n\xfamero]` | PASSED | 8.1 |
| `test_una_opcion_invalida_vuelve_a_preguntar[0-n\xfamero fuera de rango por abajo]` | PASSED | 7.6 |
...
| Prueba | Estado | Tiempo (ms) |
|---|---|---|
| `test_una_preferencia_no_configurada_devuelve_el_valor_por_defecto` | PASSED | 8.5 |
| `test_la_preferencia_sobrevive_al_reinicio_del_sistema` | PASSED | 8.4 |
| `test_reconfigurar_reemplaza_en_vez_de_duplicar` | PASSED | 9.3 |
| `test_los_valores_se_guardan_como_texto` | PASSED | 8.5 |
| `test_la_migracion_no_toca_una_base_ya_existente` | PASSED | 10.2 |

### `tests/integration/test_consultas_progreso.py`

| Prueba | Estado | Tiempo (ms) |
|---|---|---|
| `test_la_precision_ignora_los_estados_transitorios` | PASSED | 21.0 |
| `test_un_alumno_sin_mediciones_aparece_con_precision_desconocida` | PASSED | 21.7 |
| `test_todos_los_alumnos_aparecen_aunque_no_hayan_entrenado` | PASSED | 20.6 |
| `test_las_sesiones_se_listan_de_la_mas_reciente_a_la_mas_antigua` | PASSED | 18.9 |
| `test_cada_sesion_trae_su_propia_precision` | PASSED | 16.4 |
| `test_una_sesion_abierta_se_distingue_de_una_cerrada` | PASSED | 18.2 |
| `test_un_alumno_sin_sesiones_devuelve_lista_vacia` | PASSED | 19.8 |
| `test_las_tecnicas_se_ordenan_de_la_mas_floja_a_la_mas_solida` | PASSED | 18.6 |
| `test_el_desempeno_puede_acotarse_a_una_sola_sesion` | PASSED | 19.8 |
| `test_el_angulo_medio_se_promedia_por_tecnica` | PASSED | 27.2 |
| `test_el_detalle_de_sesion_identifica_al_alumno_y_al_entrenador` | PASSED | 24.2 |
| `test_una_sesion_inexistente_devuelve_none` | PASSED | 18.8 |
| `test_los_errores_se_agrupan_y_ordenan_por_frecuencia` | PASSED | 20.8 |
| `test_una_sesion_sin_errores_no_reporta_correcciones` | PASSED | 20.4 |

### `tests/integration/test_database.py`

| Prueba | Estado | Tiempo (ms) |
|---|---|---|
| `test_primer_arranque_no_tiene_entrenadores` | PASSED | 7.8 |
| `test_registro_y_autenticacion_exitosa` | PASSED | 8.9 |
| `test_credenciales_invalidas_no_dan_acceso[sholweger-clave_incorrecta-contrase\xf1a equivocada]` | PASSED | 8.5 |
| `test_credenciales_invalidas_no_dan_acceso[usuario_inexistente-clave123-usuario que no existe]` | PASSED | 11.9 |
| `test_credenciales_invalidas_no_dan_acceso[SHOLWEGER-clave123-usuario con distinta capitalizaci\xf3n]` | PASSED | 9.1 |
| `test_credenciales_invalidas_no_dan_acceso[--credenciales vac\xedas]` | PASSED | 10.6 |
| `test_la_contrasena_nunca_se_guarda_en_texto_plano` | PASSED | 10.9 |
| `test_no_se_permiten_dos_entrenadores_con_el_mismo_usuario` | PASSED | 10.4 |
| `test_el_rol_por_defecto_es_sensei` | PASSED | 9.7 |
| `test_los_atletas_se_listan_alfabeticamente` | PASSED | 13.7 |
| `test_crear_atleta_devuelve_un_identificador_utilizable` | PASSED | 8.4 |
| `test_los_datos_opcionales_del_atleta_pueden_omitirse` | PASSED | 8.1 |
| `test_una_sesion_abierta_no_tiene_hora_de_fin` | PASSED | 11.7 |
| `test_cerrar_sesion_registra_la_hora_de_fin` | PASSED | 11.2 |
| `test_la_sesion_queda_ligada_al_atleta_y_al_entrenador` | PASSED | 11.2 |
| `test_guardar_y_recuperar_una_medicion` | PASSED | 12.1 |
| `test_el_veredicto_se_persiste_en_los_tres_estados[True-1]` | PASSED | 11.3 |
| `test_el_veredicto_se_persiste_en_los_tres_estados[False-0]` | PASSED | 13.4 |
| `test_el_veredicto_se_persiste_en_los_tres_estados[None-None]` | PASSED | 12.8 |
| `test_el_historial_solo_devuelve_las_mediciones_del_atleta_consultado` | PASSED | 14.5 |
| `test_un_atleta_sin_entrenamientos_tiene_historial_vacio` | PASSED | 8.8 |
| `test_las_mediciones_sobreviven_al_cierre_de_la_aplicacion` | PASSED | 13.9 |
| `test_migra_una_base_de_datos_creada_sin_la_columna_correcto` | PASSED | 11.2 |
| `test_abrir_dos_veces_la_misma_base_no_duplica_el_esquema` | PASSED | 8.4 |
...
| Prueba | Estado | Tiempo (ms) |
|---|---|---|
| `test_treinta_frames_identicos_generan_una_sola_fila` | PASSED | 11.7 |
| `test_cada_cambio_real_de_diagnostico_se_registra` | PASSED | 13.8 |
| `test_un_diagnostico_repetido_tras_cambiar_se_vuelve_a_registrar` | PASSED | 12.5 |
| `test_las_categorias_se_rastrean_por_separado` | PASSED | 12.1 |
| `test_traduce_la_categoria_interna_a_un_nombre_legible` | PASSED | 17.4 |
| `test_ignora_entradas_que_no_son_diagnosticos_reales[diagnostico0-mensaje vac\xedo (solo dibuja el n\xfamero del \xe1ngulo en pantalla)]` | PASSED | 12.5 |
| `test_ignora_entradas_que_no_son_diagnosticos_reales[diagnostico1-sin categor\xeda]` | PASSED | 10.1 |
| `test_ignora_entradas_que_no_son_diagnosticos_reales[diagnostico2-diccionario incompleto]` | PASSED | 9.9 |
| `test_conserva_angulo_veredicto_y_marca_de_tiempo` | PASSED | 11.7 |
| `test_registra_una_lista_completa_de_diagnosticos_de_un_frame` | PASSED | 13.1 |

### `tests/integration/test_panel_inicio.py`

| Prueba | Estado | Tiempo (ms) |
|---|---|---|
| `test_un_alumno_puede_inscribirse_solo_con_su_nombre` | PASSED | 8.2 |
| `test_la_ficha_completa_se_guarda_y_se_recupera` | PASSED | 7.4 |
| `test_un_alumno_inexistente_devuelve_none_en_vez_de_reventar` | PASSED | 6.5 |
| `test_la_migracion_agrega_la_ficha_a_una_base_que_ya_tenia_alumnos` | PASSED | 14.3 |
| `test_un_dojo_sin_actividad_no_reporta_cero_por_ciento` | PASSED | 9.5 |
| `test_la_ventana_de_actividad_deja_fuera_las_sesiones_viejas` | PASSED | 19.7 |
| `test_los_estados_transitorios_no_alteran_las_metricas_del_panel` | PASSED | 20.4 |
| `test_las_sesiones_recientes_abarcan_a_todo_el_dojo` | PASSED | 15.6 |
| `test_las_sesiones_recientes_respetan_el_limite` | PASSED | 16.1 |
| `test_sin_sesiones_la_lista_viene_vacia_y_no_falla` | PASSED | 10.1 |
| `test_las_tecnicas_se_ordenan_por_cuanto_se_practican` | PASSED | 24.8 |
| `test_las_tecnicas_practicadas_pueden_acotarse_a_la_ventana_reciente` | PASSED | 14.4 |
...
| `test_no_genera_grafica_si_la_sesion_no_dejo_evaluaciones` | PASSED | 231.1 |
| `test_genera_un_png_con_el_historial_de_dos_sesiones` | PASSED | 195.4 |
| `test_crea_la_carpeta_de_evidencias_si_no_existe` | PASSED | 168.6 |
| `test_dos_reportes_seguidos_no_se_sobrescriben` | PASSED | 300.8 |

### `tests/integration/test_umbrales.py`

| Prueba | Estado | Tiempo (ms) |
|---|---|---|
| `test_la_siembra_es_idempotente` | PASSED | 13.7 |
| `test_las_reglas_usan_los_umbrales_de_la_base` | PASSED | 12.1 |
| `test_recalibrar_crea_version_nueva_sin_borrar_la_anterior` | PASSED | 12.5 |
| `test_la_medicion_conserva_el_umbral_que_la_juzgo` | PASSED | 16.9 |
| `test_rechaza_un_maximo_menor_que_el_minimo` | PASSED | 10.7 |
| `test_la_maquina_de_estados_hereda_el_umbral_de_kime` | PASSED | 10.1 |
| `test_sin_base_de_datos_usa_los_valores_de_literatura` | PASSED | 0.2 |
| `test_un_umbral_sin_maximo_no_limita_por_arriba` | PASSED | 0.2 |
| `test_una_correccion_de_literatura_alcanza_a_una_base_ya_sembrada` | PASSED | 12.2 |
| `test_una_correccion_no_pisa_lo_que_el_entrenador_recalibro` | PASSED | 11.2 |
| `test_aplicar_la_correccion_dos_veces_no_crea_versiones_repetidas` | PASSED | 9.4 |
...
| `test_los_indices_se_convierten_a_entero[0-0_1]` | PASSED | 0.4 |
...
| `test_una_fuente_ininteligible_se_rechaza_con_un_mensaje_util[\xedndice dos]` | PASSED | 0.4 |
...
| `test_tsuki_hiperextendido_se_marca_como_peligro[175.1]` | PASSED | 0.4 |
...
| `test_kokutsu_dachi_carga_el_peso_en_la_pierna_trasera[175-120-True]` | PASSED | 0.4 |
...
| `test_el_tiempo_se_lee_como_un_cronometro[999-00:00]` | PASSED | 0.4 |
...
| `test_rechaza_un_requisito_mal_escrito[RF-5]` | PASSED | 0.5 |
| `test_rechaza_un_requisito_mal_escrito[REQ-01]` | PASSED | 0.3 |
| `test_rechaza_un_requisito_mal_escrito[RF01]` | PASSED | 0.4 |
...
| `test_detecta_identificadores_repetidos` | PASSED | 0.4 |
...
| `test_la_ficha_completa_se_traduce_a_los_argumentos_de_crear_atleta` | PASSED | 0.6 |
...
| `test_el_peso_admite_coma_decimal[62,5-62.5]` | PASSED | 0.5 |
...
| Prueba | Estado | Tiempo (ms) |
|---|---|---|
| `test_acepta_las_formas_validas_de_escribir_un_rango[160-175-esperado0]` | PASSED | 0.5 |
| `test_acepta_las_formas_validas_de_escribir_un_rango[160.5-175.5-esperado1]` | PASSED | 0.5 |
| `test_acepta_las_formas_validas_de_escribir_un_rango[160,5-175-esperado2]` | PASSED | 0.4 |
| `test_acepta_las_formas_validas_de_escribir_un_rango[  160 - 175 -esperado3]` | PASSED | 0.5 |
| `test_acepta_las_formas_validas_de_escribir_un_rango[0-180-esperado4]` | PASSED | 0.5 |
...
| `test_un_maximo_vacio_significa_sin_limite_superior[Sin Limite]` | PASSED | 0.3 |
...
| `test_rechaza_los_rangos_imposibles[-175-m\xednimo es obligatorio]` | PASSED | 0.5 |
...
| `test_rechaza_los_rangos_imposibles[160-200-supera los 180]` | PASSED | 0.6 |
...
- Aviso: la serie de IDs tiene huecos: TC-AUTO-013, TC-AUTO-014, TC-AUTO-017, TC-AUTO-021, TC-AUTO-022, TC-AUTO-027
- Aviso: los huecos anteriores se explican por 6 módulo(s) omitido(s) en este entorno; no se cuentan como incumplimiento
