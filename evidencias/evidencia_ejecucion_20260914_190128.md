...
|---|---|---|---|---|---|
| Unitaria | 297 | 297 | 0 | 0 | 0.09 |
| Integración | 141 | 141 | 0 | 0 | 1.89 |
| Interfaz (UI/E2E) | 74 | 74 | 0 | 0 | 28.35 |
| **Total** | **512** | **512** | **0** | **0** | **30.33** |
...
|---|---|---|
| `test_lista_las_camaras_detectadas_en_el_equipo` | PASSED | 321.6 |
| `test_la_fuente_elegida_se_verifica_y_persiste` | PASSED | 323.3 |
| `test_una_camara_que_no_abre_no_se_guarda` | PASSED | 303.8 |
| `test_una_camara_que_abre_pero_no_entrega_imagen_se_rechaza` | PASSED | 300.0 |
| `test_la_camara_ip_se_guarda_como_direccion_completa` | PASSED | 330.2 |
| `test_elegir_camara_ip_sin_escribir_la_direccion_avisa` | PASSED | 289.4 |
| `test_avisa_cuando_la_camara_configurada_ya_no_esta_conectada` | PASSED | 287.8 |
| `test_volver_regresa_al_panel_de_inicio` | PASSED | 348.0 |
| `test_abrir_la_pantalla_con_una_camara_ip_ya_configurada_no_inventa_un_error` | PASSED | 318.0 |

### `tests/e2e/test_gui_flow.py`

| Prueba | Estado | Tiempo (ms) |
|---|---|---|
| `test_el_primer_arranque_pide_crear_la_cuenta_inicial` | PASSED | 79.0 |
| `test_crear_la_primera_cuenta_lleva_al_panel_de_inicio` | PASSED | 210.5 |
| `test_no_permite_crear_una_cuenta_incompleta` | PASSED | 82.3 |
| `test_login_con_credenciales_correctas` | PASSED | 219.3 |
| `test_login_con_credenciales_incorrectas_muestra_error` | PASSED | 68.6 |
| `test_elegir_un_perfil_abre_la_sesion_de_analisis` | PASSED | 891.9 |
| `test_el_video_se_embebe_en_la_ventana` | PASSED | 496.0 |
| `test_terminar_la_sesion_cierra_el_registro_y_libera_la_camara` | PASSED | 745.4 |
| `test_el_acceso_no_muestra_barra_lateral` | PASSED | 68.2 |
| `test_tras_autenticarse_aparece_la_barra_con_la_seccion_de_inicio_activa` | PASSED | 204.1 |
| `test_cada_seccion_de_la_barra_abre_su_pantalla[inicio-InicioScreen]` | PASSED | 294.5 |
| `test_cada_seccion_de_la_barra_abre_su_pantalla[vivo-LiveScreen]` | PASSED | 333.3 |
| `test_cada_seccion_de_la_barra_abre_su_pantalla[historial-HistorialScreen]` | PASSED | 253.1 |
| `test_cada_seccion_de_la_barra_abre_su_pantalla[tecnicas-TecnicasScreen]` | PASSED | 384.8 |
| `test_cada_seccion_de_la_barra_abre_su_pantalla[camara-CamaraScreen]` | PASSED | 349.1 |
| `test_la_calibracion_se_alcanza_desde_tecnicas_y_no_desde_la_barra` | PASSED | 563.3 |
| `test_la_barra_sobrevive_al_cambiar_de_seccion` | PASSED | 368.6 |
| `test_el_detalle_de_un_alumno_conserva_marcada_la_seccion_de_historial` | PASSED | 293.2 |
| `test_cerrar_sesion_de_entrenador_retira_la_barra_y_vuelve_al_acceso` | PASSED | 277.3 |
| `test_un_usuario_repetido_se_explica_en_pantalla_en_vez_de_reventar` | PASSED | 76.0 |

### `tests/e2e/test_gui_historial.py`

| Prueba | Estado | Tiempo (ms) |
|---|---|---|
| `test_el_historial_lista_a_todos_los_alumnos` | PASSED | 328.2 |
| `test_el_alumno_sin_entrenar_aparece_sin_precision` | PASSED | 277.9 |
| `test_volver_desde_el_historial_regresa_a_perfiles` | PASSED | 368.7 |
| `test_el_reporte_de_progreso_se_genera_desde_la_pantalla` | PASSED | 496.8 |
| `test_sin_evaluaciones_cerradas_se_explica_en_vez_de_generar_un_grafico_vacio` | PASSED | 322.7 |
| `test_el_perfil_muestra_el_desempeno_por_tecnica` | PASSED | 309.9 |
| `test_el_reporte_de_sesion_resume_y_ordena_los_errores` | PASSED | 351.0 |
| `test_un_reporte_de_sesion_inexistente_no_rompe_la_pantalla` | PASSED | 246.4 |
| `test_volver_desde_el_reporte_regresa_al_perfil_del_alumno` | PASSED | 407.0 |
| `test_la_biblioteca_muestra_las_tecnicas_que_el_sistema_evalua` | PASSED | 360.8 |
| `test_la_biblioteca_refleja_una_recalibracion_del_entrenador` | PASSED | 342.1 |
| `test_desde_la_biblioteca_se_llega_a_la_calibracion` | PASSED | 534.9 |

### `tests/e2e/test_gui_inicio.py`

| Prueba | Estado | Tiempo (ms) |
|---|---|---|
| `test_tras_autenticarse_se_abre_el_panel_de_inicio` | PASSED | 202.5 |
| `test_un_dojo_sin_actividad_lo_dice_en_vez_de_mostrar_cifras_en_cero` | PASSED | 215.3 |
| `test_el_panel_refleja_la_actividad_real_del_dojo` | PASSED | 297.1 |
| `test_el_panel_declara_que_no_hay_sensores_inerciales` | PASSED | 214.2 |
| `test_desde_el_inicio_se_llega_al_analisis_en_vivo_y_al_historial` | PASSED | 428.0 |
| `test_cambiar_de_perfil_pide_la_contrasena_del_sensei` | PASSED | 345.1 |
| `test_la_seleccion_lista_senseis_y_no_alumnos` | PASSED | 247.8 |
| `test_la_lista_de_senseis_nunca_expone_el_hash_de_la_contrasena` | PASSED | 11.2 |
| `test_los_alumnos_se_inscriben_desde_su_propia_seccion` | PASSED | 345.0 |
| `test_el_campo_de_grado_solo_aparece_para_cinta_cafe_o_negra` | PASSED | 340.2 |
| `test_un_formulario_invalido_no_inscribe_a_nadie` | PASSED | 325.6 |
| `test_abrir_el_registro_dos_veces_no_duplica_la_ventana` | PASSED | 353.2 |
| `test_el_reporte_señala_la_asimetria_entre_lados` | PASSED | 380.3 |
| `test_una_sesion_limpia_declara_que_no_hay_senales_de_riesgo` | PASSED | 364.1 |
| `test_el_reporte_traduce_los_errores_a_instrucciones` | PASSED | 297.5 |

### `tests/e2e/test_gui_umbrales.py`

| Prueba | Estado | Tiempo (ms) |
|---|---|---|
| `test_la_pantalla_lista_todos_los_umbrales_vigentes` | PASSED | 451.8 |
| `test_recalibrar_cambia_el_criterio_del_sistema_experto` | PASSED | 602.7 |
| `test_un_campo_invalido_no_guarda_ninguno_de_los_cambios` | PASSED | 431.2 |
| `test_guardar_sin_tocar_nada_no_crea_versiones_nuevas` | PASSED | 437.8 |
| `test_descartar_devuelve_los_campos_al_valor_vigente` | PASSED | 582.3 |
| `test_sin_entrenador_la_pantalla_queda_en_solo_lectura` | PASSED | 295.2 |
| `test_el_historial_abre_una_sola_ventana_con_las_versiones_del_umbral` | PASSED | 680.9 |
| `test_una_base_sin_umbrales_lo_informa_en_vez_de_mostrar_una_tabla_vacia` | PASSED | 430.0 |
| `test_volver_regresa_al_panel_de_inicio` | PASSED | 520.7 |

### `tests/e2e/test_gui_vivo.py`

| Prueba | Estado | Tiempo (ms) |
|---|---|---|
| `test_sin_alumno_elegido_no_se_abre_la_camara_ni_se_crea_sesion` | PASSED | 335.6 |
| `test_el_desplegable_ofrece_a_todos_los_alumnos_inscritos` | PASSED | 928.4 |
| `test_cambiar_de_alumno_cierra_la_sesion_anterior_y_abre_otra` | PASSED | 899.4 |
| `test_elegir_al_mismo_alumno_no_abre_una_sesion_nueva` | PASSED | 734.8 |
| `test_salir_de_la_seccion_cierra_la_sesion_en_curso` | PASSED | 691.5 |
| `test_el_video_se_ajusta_al_hueco_sin_deformarse` | PASSED | 544.9 |
| `test_el_escalado_nunca_devuelve_un_tamano_nulo` | PASSED | 602.4 |
| `test_un_fotograma_grande_no_agranda_el_contenedor_del_video` | PASSED | 554.7 |
| `test_el_tamano_de_dibujado_no_altera_los_angulos_medidos` | PASSED | 832.1 |
...
| `test_el_angulo_medido_coincide_con_la_pose_ejecutada` | PASSED | 0.5 |
| `test_brazo_no_visible_se_informa_en_vez_de_inventar_diagnostico` | PASSED | 0.3 |
| `test_el_filtro_se_reinicia_cuando_el_brazo_desaparece` | PASSED | 0.4 |
| `test_el_suavizado_amortigua_un_salto_de_jitter` | PASSED | 0.4 |
| `test_identifica_la_postura_antes_de_evaluarla[posicion natural-175-175-POSTURA NATURAL]` | PASSED | 0.7 |
| `test_identifica_la_postura_antes_de_evaluarla[postura de jinete-140-140-KIBA DACHI]` | PASSED | 0.5 |
...
| `test_la_guardia_se_deduce_de_la_profundidad_de_los_tobillos` | PASSED | 0.3 |
...
| `test_una_patada_completa_atraviesa_el_analizador` | PASSED | 0.4 |
...
| `test_todo_diagnostico_cumple_el_contrato_de_la_capa_visual[analyze_stance]` | PASSED | 0.3 |
| `test_las_lineas_de_texto_no_se_encimam_en_pantalla` | PASSED | 0.2 |
| `test_un_kokutsu_real_no_se_confunde_con_una_transicion[170-100]` | PASSED | 0.4 |
| `test_un_kokutsu_real_no_se_confunde_con_una_transicion[165-105]` | PASSED | 0.4 |
...
| `test_zenkutsu_y_kokutsu_no_se_confunden_entre_si` | PASSED | 0.3 |

### `tests/integration/test_cli_auth.py`

| Prueba | Estado | Tiempo (ms) |
|---|---|---|
| `test_el_primer_uso_registra_al_entrenador_principal` | PASSED | 11.9 |
| `test_login_exitoso_de_un_entrenador_existente` | PASSED | 10.7 |
| `test_reintento_tras_una_contrasena_equivocada` | PASSED | 10.9 |
| `test_tras_fallar_puede_crear_una_cuenta_de_sensei_asistente` | PASSED | 11.6 |
| `test_elegir_un_perfil_existente_de_la_lista` | PASSED | 11.3 |
| `test_crear_un_perfil_nuevo_desde_la_lista` | PASSED | 10.8 |
| `test_el_grado_del_cinturon_es_opcional` | PASSED | 10.6 |
| `test_una_opcion_invalida_vuelve_a_preguntar[abc-texto en vez de n\xfamero]` | PASSED | 11.5 |
| `test_una_opcion_invalida_vuelve_a_preguntar[0-n\xfamero fuera de rango por abajo]` | PASSED | 9.3 |
| `test_una_opcion_invalida_vuelve_a_preguntar[99-n\xfamero fuera de rango por arriba]` | PASSED | 9.2 |

### `tests/integration/test_configuracion.py`

| Prueba | Estado | Tiempo (ms) |
|---|---|---|
| `test_una_preferencia_no_configurada_devuelve_el_valor_por_defecto` | PASSED | 8.2 |
| `test_la_preferencia_sobrevive_al_reinicio_del_sistema` | PASSED | 11.9 |
| `test_reconfigurar_reemplaza_en_vez_de_duplicar` | PASSED | 12.1 |
| `test_los_valores_se_guardan_como_texto` | PASSED | 10.8 |
| `test_la_migracion_no_toca_una_base_ya_existente` | PASSED | 13.4 |

### `tests/integration/test_consultas_progreso.py`

| Prueba | Estado | Tiempo (ms) |
|---|---|---|
| `test_la_precision_ignora_los_estados_transitorios` | PASSED | 22.4 |
| `test_un_alumno_sin_mediciones_aparece_con_precision_desconocida` | PASSED | 21.9 |
| `test_todos_los_alumnos_aparecen_aunque_no_hayan_entrenado` | PASSED | 22.6 |
| `test_las_sesiones_se_listan_de_la_mas_reciente_a_la_mas_antigua` | PASSED | 23.6 |
| `test_cada_sesion_trae_su_propia_precision` | PASSED | 24.9 |
| `test_una_sesion_abierta_se_distingue_de_una_cerrada` | PASSED | 20.0 |
| `test_un_alumno_sin_sesiones_devuelve_lista_vacia` | PASSED | 19.6 |
| `test_las_tecnicas_se_ordenan_de_la_mas_floja_a_la_mas_solida` | PASSED | 17.6 |
| `test_el_desempeno_puede_acotarse_a_una_sola_sesion` | PASSED | 18.5 |
| `test_el_angulo_medio_se_promedia_por_tecnica` | PASSED | 19.1 |
| `test_el_detalle_de_sesion_identifica_al_alumno_y_al_entrenador` | PASSED | 22.6 |
| `test_una_sesion_inexistente_devuelve_none` | PASSED | 19.3 |
| `test_los_errores_se_agrupan_y_ordenan_por_frecuencia` | PASSED | 22.9 |
| `test_una_sesion_sin_errores_no_reporta_correcciones` | PASSED | 28.2 |

### `tests/integration/test_database.py`

| Prueba | Estado | Tiempo (ms) |
|---|---|---|
| `test_primer_arranque_no_tiene_entrenadores` | PASSED | 12.3 |
| `test_registro_y_autenticacion_exitosa` | PASSED | 12.8 |
| `test_credenciales_invalidas_no_dan_acceso[sholweger-clave_incorrecta-contrase\xf1a equivocada]` | PASSED | 19.0 |
| `test_credenciales_invalidas_no_dan_acceso[usuario_inexistente-clave123-usuario que no existe]` | PASSED | 10.2 |
| `test_credenciales_invalidas_no_dan_acceso[SHOLWEGER-clave123-usuario con distinta capitalizaci\xf3n]` | PASSED | 11.0 |
| `test_credenciales_invalidas_no_dan_acceso[--credenciales vac\xedas]` | PASSED | 11.0 |
| `test_la_contrasena_nunca_se_guarda_en_texto_plano` | PASSED | 9.8 |
| `test_no_se_permiten_dos_entrenadores_con_el_mismo_usuario` | PASSED | 9.3 |
| `test_el_rol_por_defecto_es_sensei` | PASSED | 11.1 |
| `test_los_atletas_se_listan_alfabeticamente` | PASSED | 11.1 |
| `test_crear_atleta_devuelve_un_identificador_utilizable` | PASSED | 8.8 |
| `test_los_datos_opcionales_del_atleta_pueden_omitirse` | PASSED | 10.5 |
| `test_una_sesion_abierta_no_tiene_hora_de_fin` | PASSED | 10.7 |
| `test_cerrar_sesion_registra_la_hora_de_fin` | PASSED | 12.8 |
| `test_la_sesion_queda_ligada_al_atleta_y_al_entrenador` | PASSED | 12.2 |
| `test_guardar_y_recuperar_una_medicion` | PASSED | 11.4 |
| `test_el_veredicto_se_persiste_en_los_tres_estados[True-1]` | PASSED | 11.4 |
| `test_el_veredicto_se_persiste_en_los_tres_estados[False-0]` | PASSED | 10.8 |
| `test_el_veredicto_se_persiste_en_los_tres_estados[None-None]` | PASSED | 12.1 |
| `test_el_historial_solo_devuelve_las_mediciones_del_atleta_consultado` | PASSED | 12.7 |
| `test_un_atleta_sin_entrenamientos_tiene_historial_vacio` | PASSED | 8.5 |
| `test_las_mediciones_sobreviven_al_cierre_de_la_aplicacion` | PASSED | 11.5 |
| `test_migra_una_base_de_datos_creada_sin_la_columna_correcto` | PASSED | 10.4 |
| `test_abrir_dos_veces_la_misma_base_no_duplica_el_esquema` | PASSED | 9.6 |

### `tests/integration/test_kick_state_machine.py`

| Prueba | Estado | Tiempo (ms) |
|---|---|---|
| `test_ciclo_completo_de_una_patada_correcta` | PASSED | 0.3 |
...
| Prueba | Estado | Tiempo (ms) |
|---|---|---|
| `test_treinta_frames_identicos_generan_una_sola_fila` | PASSED | 12.7 |
| `test_cada_cambio_real_de_diagnostico_se_registra` | PASSED | 12.6 |
| `test_un_diagnostico_repetido_tras_cambiar_se_vuelve_a_registrar` | PASSED | 12.5 |
| `test_las_categorias_se_rastrean_por_separado` | PASSED | 12.7 |
| `test_traduce_la_categoria_interna_a_un_nombre_legible` | PASSED | 14.1 |
| `test_ignora_entradas_que_no_son_diagnosticos_reales[diagnostico0-mensaje vac\xedo (solo dibuja el n\xfamero del \xe1ngulo en pantalla)]` | PASSED | 11.1 |
| `test_ignora_entradas_que_no_son_diagnosticos_reales[diagnostico1-sin categor\xeda]` | PASSED | 10.5 |
| `test_ignora_entradas_que_no_son_diagnosticos_reales[diagnostico2-diccionario incompleto]` | PASSED | 10.2 |
| `test_conserva_angulo_veredicto_y_marca_de_tiempo` | PASSED | 11.9 |
| `test_registra_una_lista_completa_de_diagnosticos_de_un_frame` | PASSED | 11.5 |

### `tests/integration/test_panel_inicio.py`

| Prueba | Estado | Tiempo (ms) |
|---|---|---|
| `test_un_alumno_puede_inscribirse_solo_con_su_nombre` | PASSED | 8.5 |
| `test_la_ficha_completa_se_guarda_y_se_recupera` | PASSED | 8.2 |
| `test_un_alumno_inexistente_devuelve_none_en_vez_de_reventar` | PASSED | 8.1 |
| `test_la_migracion_agrega_la_ficha_a_una_base_que_ya_tenia_alumnos` | PASSED | 13.2 |
| `test_un_dojo_sin_actividad_no_reporta_cero_por_ciento` | PASSED | 9.2 |
| `test_la_ventana_de_actividad_deja_fuera_las_sesiones_viejas` | PASSED | 20.1 |
| `test_los_estados_transitorios_no_alteran_las_metricas_del_panel` | PASSED | 17.9 |
| `test_las_sesiones_recientes_abarcan_a_todo_el_dojo` | PASSED | 11.7 |
| `test_las_sesiones_recientes_respetan_el_limite` | PASSED | 15.3 |
| `test_sin_sesiones_la_lista_viene_vacia_y_no_falla` | PASSED | 7.4 |
| `test_las_tecnicas_se_ordenan_por_cuanto_se_practican` | PASSED | 19.7 |
| `test_las_tecnicas_practicadas_pueden_acotarse_a_la_ventana_reciente` | PASSED | 15.2 |
| `test_el_desempeno_se_separa_por_lado_del_cuerpo` | PASSED | 26.0 |
| `test_los_diagnosticos_sin_lado_no_se_atribuyen_a_ninguno` | PASSED | 16.1 |
| `test_se_cuentan_los_diagnosticos_que_contienen_un_fragmento` | PASSED | 25.3 |
| `test_una_sesion_sin_mediciones_devuelve_ceros_y_no_none` | PASSED | 10.7 |

### `tests/integration/test_renderer.py`

| Prueba | Estado | Tiempo (ms) |
|---|---|---|
| `test_sin_persona_detectada_el_video_se_devuelve_intacto` | PASSED | 1.1 |
| `test_dibuja_el_esqueleto_cuando_hay_pose` | PASSED | 1.0 |
| `test_el_mapa_anatomico_no_referencia_puntos_inexistentes` | PASSED | 0.3 |
| `test_dibuja_el_texto_del_diagnostico` | PASSED | 28.2 |
| `test_un_diagnostico_sin_angulo_no_rompe_el_dibujado` | PASSED | 1.0 |
| `test_una_lista_vacia_de_diagnosticos_deja_el_frame_igual` | PASSED | 0.7 |
| `test_el_color_del_diagnostico_llega_al_frame` | PASSED | 1.0 |
...
| `test_calcula_el_porcentaje_de_aciertos[veredictos1-75.0]` | PASSED | 0.3 |
...
| `test_no_genera_grafica_si_la_sesion_no_dejo_evaluaciones` | PASSED | 13.7 |
| `test_genera_un_png_con_el_historial_de_dos_sesiones` | PASSED | 185.4 |
| `test_crea_la_carpeta_de_evidencias_si_no_existe` | PASSED | 155.4 |
| `test_dos_reportes_seguidos_no_se_sobrescriben` | PASSED | 304.8 |

### `tests/integration/test_umbrales.py`

| Prueba | Estado | Tiempo (ms) |
|---|---|---|
| `test_la_siembra_es_idempotente` | PASSED | 11.8 |
| `test_las_reglas_usan_los_umbrales_de_la_base` | PASSED | 9.5 |
| `test_recalibrar_crea_version_nueva_sin_borrar_la_anterior` | PASSED | 10.5 |
| `test_la_medicion_conserva_el_umbral_que_la_juzgo` | PASSED | 14.4 |
| `test_rechaza_un_maximo_menor_que_el_minimo` | PASSED | 8.7 |
| `test_la_maquina_de_estados_hereda_el_umbral_de_kime` | PASSED | 10.4 |
| `test_sin_base_de_datos_usa_los_valores_de_literatura` | PASSED | 0.2 |
| `test_un_umbral_sin_maximo_no_limita_por_arriba` | PASSED | 0.2 |
| `test_una_correccion_de_literatura_alcanza_a_una_base_ya_sembrada` | PASSED | 11.4 |
| `test_una_correccion_no_pisa_lo_que_el_entrenador_recalibro` | PASSED | 9.8 |
| `test_aplicar_la_correccion_dos_veces_no_crea_versiones_repetidas` | PASSED | 8.7 |

### `tests/unit/test_coaching.py`

| Prueba | Estado | Tiempo (ms) |
|---|---|---|
| `test_ningun_veredicto_del_motor_se_queda_sin_correccion` | PASSED | 0.4 |
| `test_la_tabla_no_esta_vacia` | PASSED | 0.2 |
| `test_la_correccion_dice_que_hacer_y_por_que` | PASSED | 0.2 |
| `test_el_lado_se_separa_del_veredicto[IZQ - TSUKI: EXCELENTE-izquierdo]` | PASSED | 0.3 |
...
| `test_promedia_mientras_el_buffer_se_llena` | PASSED | 0.2 |
| `test_la_ventana_descarta_la_medicion_mas_antigua` | PASSED | 0.2 |
| `test_ventana_de_uno_no_suaviza` | PASSED | 0.2 |
| `test_reset_borra_el_historial` | PASSED | 0.2 |
| `test_reduce_la_dispersion_del_ruido` | PASSED | 0.4 |
| `test_conserva_el_nivel_de_una_senal_estable` | PASSED | 0.2 |
...
| Prueba | Estado | Tiempo (ms) |
|---|---|---|
| `test_reconoce_una_camara_de_red[http://192.168.1.50:8080/video]` | PASSED | 0.4 |
| `test_reconoce_una_camara_de_red[https://camara.dojo.local/stream]` | PASSED | 0.3 |
| `test_reconoce_una_camara_de_red[rtsp://192.168.0.10:554/live]` | PASSED | 0.3 |
| `test_reconoce_una_camara_de_red[  http://10.0.0.4:4747/video  ]` | PASSED | 0.3 |
| `test_reconoce_una_camara_de_red[HTTP://192.168.1.50:8080/video]` | PASSED | 0.4 |
| `test_no_confunde_un_dispositivo_local_con_una_direccion[0_0]` | PASSED | 0.4 |
...
| `test_no_confunde_un_dispositivo_local_con_una_direccion[2_1]` | PASSED | 0.4 |
| `test_no_confunde_un_dispositivo_local_con_una_direccion[]` | PASSED | 0.2 |
| `test_no_confunde_un_dispositivo_local_con_una_direccion[camara]` | PASSED | 0.4 |
| `test_no_confunde_un_dispositivo_local_con_una_direccion[None]` | PASSED | 0.7 |
| `test_los_indices_se_convierten_a_entero[0-0_0]` | PASSED | 0.5 |
| `test_los_indices_se_convierten_a_entero[2-2_0]` | PASSED | 0.4 |
| `test_los_indices_se_convierten_a_entero[0-0_1]` | PASSED | 0.3 |
| `test_los_indices_se_convierten_a_entero[2-2_1]` | PASSED | 0.5 |
| `test_una_url_se_conserva_como_texto_y_sin_espacios` | PASSED | 0.2 |
| `test_una_fuente_ininteligible_se_rechaza_con_un_mensaje_util[camara]` | PASSED | 0.5 |
| `test_una_fuente_ininteligible_se_rechaza_con_un_mensaje_util[]` | PASSED | 0.5 |
| `test_una_fuente_ininteligible_se_rechaza_con_un_mensaje_util[None]` | PASSED | 0.5 |
| `test_una_fuente_ininteligible_se_rechaza_con_un_mensaje_util[1.2.3]` | PASSED | 0.4 |
| `test_una_fuente_ininteligible_se_rechaza_con_un_mensaje_util[\xedndice dos]` | PASSED | 0.3 |
| `test_la_descripcion_distingue_red_de_dispositivo_local` | PASSED | 0.3 |
...
| `test_calcula_el_angulo_interno_conocido[extension total-a1-b1-c1-180.0]` | PASSED | 0.7 |
| `test_calcula_el_angulo_interno_conocido[brazo plegado-a2-b2-c2-0.0]` | PASSED | 0.7 |
| `test_calcula_el_angulo_interno_conocido[tsuki en rango correcto-a3-b3-c3-170.3]` | PASSED | 0.8 |
| `test_calcula_el_angulo_interno_conocido[angulo agudo de 45-a4-b4-c4-45.0]` | PASSED | 0.7 |
...
| `test_reconstruye_cualquier_angulo_del_rango_articular[45]` | PASSED | 0.5 |
| `test_reconstruye_cualquier_angulo_del_rango_articular[60]` | PASSED | 0.5 |
| `test_reconstruye_cualquier_angulo_del_rango_articular[90]` | PASSED | 0.4 |
| `test_reconstruye_cualquier_angulo_del_rango_articular[120]` | PASSED | 0.6 |
| `test_reconstruye_cualquier_angulo_del_rango_articular[150]` | PASSED | 0.5 |
| `test_reconstruye_cualquier_angulo_del_rango_articular[179]` | PASSED | 0.6 |
| `test_normaliza_cuando_los_segmentos_cruzan_el_corte_angular[170--170-20]` | PASSED | 1.0 |
| `test_normaliza_cuando_los_segmentos_cruzan_el_corte_angular[150--150-60]` | PASSED | 0.6 |
| `test_normaliza_cuando_los_segmentos_cruzan_el_corte_angular[-179-179-2]` | PASSED | 0.5 |
| `test_normaliza_angulos_reflejos_al_rango_articular[190-170]` | PASSED | 0.6 |
| `test_normaliza_angulos_reflejos_al_rango_articular[270-90]` | PASSED | 0.6 |
| `test_normaliza_angulos_reflejos_al_rango_articular[350-10]` | PASSED | 0.6 |
| `test_el_resultado_nunca_sale_del_rango_0_180[0]` | PASSED | 0.6 |
| `test_el_resultado_nunca_sale_del_rango_0_180[37]` | PASSED | 0.5 |
| `test_el_resultado_nunca_sale_del_rango_0_180[90]` | PASSED | 0.4 |
| `test_el_resultado_nunca_sale_del_rango_0_180[143]` | PASSED | 0.3 |
| `test_el_resultado_nunca_sale_del_rango_0_180[180]` | PASSED | 0.3 |
| `test_es_simetrico_respecto_al_orden_de_los_extremos` | PASSED | 0.2 |
| `test_es_invariante_a_la_distancia_a_la_camara[0.5]` | PASSED | 0.3 |
...
| Prueba | Estado | Tiempo (ms) |
|---|---|---|
| `test_tsuki_correcto_dentro_del_rango_de_kime[160]` | PASSED | 0.3 |
| `test_tsuki_correcto_dentro_del_rango_de_kime[165]` | PASSED | 0.3 |
| `test_tsuki_correcto_dentro_del_rango_de_kime[170]` | PASSED | 0.3 |
...
| `test_tsuki_fronteras_exactas[159.9-False]` | PASSED | 0.3 |
...
| `test_heiko_dachi_exige_rodillas_extendidas[172.0-True]` | PASSED | 0.3 |
| `test_heiko_dachi_exige_rodillas_extendidas[180.0-True]` | PASSED | 0.3 |
| `test_kiba_dachi_exige_simetria_en_ambas_rodillas[140-140-True]` | PASSED | 0.3 |
| `test_kiba_dachi_exige_simetria_en_ambas_rodillas[130-150-True]` | PASSED | 0.3 |
| `test_kiba_dachi_exige_simetria_en_ambas_rodillas[129-140-False]` | PASSED | 0.4 |
| `test_kiba_dachi_exige_simetria_en_ambas_rodillas[140-151-False]` | PASSED | 0.3 |
...
| `test_zenkutsu_dachi_distingue_pierna_delantera_de_trasera[90-165-True]` | PASSED | 0.3 |
| `test_zenkutsu_dachi_distingue_pierna_delantera_de_trasera[115-180-True]` | PASSED | 0.3 |
| `test_zenkutsu_dachi_distingue_pierna_delantera_de_trasera[120-170-False]` | PASSED | 0.3 |
...
| `test_kokutsu_dachi_carga_el_peso_en_la_pierna_trasera[110-100-False]` | PASSED | 0.3 |
...
| `test_mae_geri_rechaza_kime_incompleto_aunque_sea_veloz[90-2000]` | PASSED | 0.3 |
...
| `test_age_uke_bloquea_solo_en_su_rango[120.0-True-EFECTIVO]` | PASSED | 0.3 |
| `test_age_uke_bloquea_solo_en_su_rango[130.0-True-EFECTIVO]` | PASSED | 0.3 |
| `test_age_uke_bloquea_solo_en_su_rango[140.0-True-EFECTIVO]` | PASSED | 0.3 |
| `test_age_uke_bloquea_solo_en_su_rango[140.1-False-DEMASIADO EXTENDIDO]` | PASSED | 0.3 |
| `test_toda_regla_devuelve_el_contrato_esperado[evaluate_tsuki-argumentos0]` | PASSED | 0.3 |
| `test_toda_regla_devuelve_el_contrato_esperado[evaluate_heiko_dachi-argumentos1]` | PASSED | 0.3 |
| `test_toda_regla_devuelve_el_contrato_esperado[evaluate_kiba_dachi-argumentos2]` | PASSED | 0.3 |
| `test_toda_regla_devuelve_el_contrato_esperado[evaluate_zenkutsu_dachi-argumentos3]` | PASSED | 0.3 |
| `test_toda_regla_devuelve_el_contrato_esperado[evaluate_kokutsu_dachi-argumentos4]` | PASSED | 0.3 |
...
| `test_toda_regla_devuelve_el_contrato_esperado[evaluate_age_uke-argumentos7]` | PASSED | 0.3 |
...
| `test_se_usa_el_modelo_cuando_falta_el_nombre_amistoso` | PASSED | 0.2 |
...
| `test_un_fallo_de_la_consulta_no_interrumpe_la_enumeracion` | PASSED | 0.3 |
...
| Prueba | Estado | Tiempo (ms) |
|---|---|---|
| `test_el_tiempo_se_lee_como_un_cronometro[0-00:00]` | PASSED | 0.4 |
...
| `test_rechaza_un_identificador_fuera_del_patron[TC-001]` | PASSED | 0.3 |
| `test_rechaza_un_identificador_fuera_del_patron[tc-auto-001]` | PASSED | 0.3 |
...
| `test_rechaza_un_identificador_fuera_del_patron[TC-AUTO-0001]` | PASSED | 0.3 |
...
| `test_un_tipo_de_prueba_inexistente_se_rechaza` | PASSED | 0.2 |
...
| `test_el_catalogo_no_lleva_fecha_ni_totales_que_cambien_en_cada_corrida` | PASSED | 0.3 |
| `test_dos_corridas_identicas_producen_exactamente_el_mismo_catalogo` | PASSED | 0.3 |
...
| `test_si_falta_una_dependencia_grafica_se_explica_como_seguir` | PASSED | 0.6 |

### `tests/unit/test_registro_alumno.py`

| Prueba | Estado | Tiempo (ms) |
|---|---|---|
| `test_el_grado_se_pide_desde_la_cinta_cafe[Caf\xe9]` | PASSED | 0.3 |
...
| `test_en_los_colores_iniciales_el_color_ya_determina_el_kyu[Amarilla]` | PASSED | 0.3 |
| `test_en_los_colores_iniciales_el_color_ya_determina_el_kyu[Naranja]` | PASSED | 0.2 |
| `test_en_los_colores_iniciales_el_color_ya_determina_el_kyu[Verde]` | PASSED | 0.3 |
| `test_en_los_colores_iniciales_el_color_ya_determina_el_kyu[Azul]` | PASSED | 0.2 |
| `test_en_los_colores_iniciales_el_color_ya_determina_el_kyu[Morada]` | PASSED | 0.2 |
| `test_los_grados_ofrecidos_corresponden_al_color` | PASSED | 0.2 |
| `test_un_grado_huerfano_no_se_guarda` | PASSED | 0.2 |
| `test_el_nombre_es_el_unico_campo_obligatorio[]` | PASSED | 0.4 |
...
| `test_un_color_de_cinta_inventado_se_rechaza` | PASSED | 0.3 |
| `test_todos_los_colores_declarados_son_aceptados` | PASSED | 0.2 |
| `test_la_edad_se_interpreta_o_queda_vacia[16-16]` | PASSED | 0.3 |
...
| `test_un_peso_imposible_se_explica[400-entre 10 y 250]` | PASSED | 0.5 |
...
| `test_una_proporcion_baja_se_reporta_como_atencion_y_no_como_riesgo` | PASSED | 0.3 |
...
| `test_una_diferencia_dentro_de_lo_normal_no_se_reporta` | PASSED | 0.3 |
...
| `test_acepta_las_formas_validas_de_escribir_un_rango[160.5-175.5-esperado1]` | PASSED | 0.3 |
| `test_acepta_las_formas_validas_de_escribir_un_rango[160,5-175-esperado2]` | PASSED | 0.3 |
| `test_acepta_las_formas_validas_de_escribir_un_rango[  160 - 175 -esperado3]` | PASSED | 0.3 |
| `test_acepta_las_formas_validas_de_escribir_un_rango[0-180-esperado4]` | PASSED | 0.4 |
...
| `test_un_maximo_vacio_significa_sin_limite_superior[ninguno]` | PASSED | 0.3 |
...
| `test_el_valor_mostrado_es_legible_para_el_entrenador[160.5-160.5]` | PASSED | 0.3 |
| `test_el_valor_mostrado_es_legible_para_el_entrenador[None-sin l\xedmite]` | PASSED | 1.0 |
