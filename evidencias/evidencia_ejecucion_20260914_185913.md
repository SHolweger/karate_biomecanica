...
| **Fecha y hora de inicio** | 2026-09-14 18:59:13 |
| **Duración total** | 35.07 s |
...
| Integración | 141 | 141 | 0 | 0 | 2.20 |
| Interfaz (UI/E2E) | 74 | 74 | 0 | 0 | 31.15 |
| **Total** | **510** | **510** | **0** | **0** | **33.44** |
...
|---|---|---|
| `test_lista_las_camaras_detectadas_en_el_equipo` | PASSED | 463.6 |
| `test_la_fuente_elegida_se_verifica_y_persiste` | PASSED | 360.6 |
| `test_una_camara_que_no_abre_no_se_guarda` | PASSED | 309.9 |
| `test_una_camara_que_abre_pero_no_entrega_imagen_se_rechaza` | PASSED | 335.2 |
| `test_la_camara_ip_se_guarda_como_direccion_completa` | PASSED | 320.2 |
| `test_elegir_camara_ip_sin_escribir_la_direccion_avisa` | PASSED | 302.9 |
| `test_avisa_cuando_la_camara_configurada_ya_no_esta_conectada` | PASSED | 313.3 |
| `test_volver_regresa_al_panel_de_inicio` | PASSED | 386.3 |
| `test_abrir_la_pantalla_con_una_camara_ip_ya_configurada_no_inventa_un_error` | PASSED | 307.2 |

### `tests/e2e/test_gui_flow.py`

| Prueba | Estado | Tiempo (ms) |
|---|---|---|
| `test_el_primer_arranque_pide_crear_la_cuenta_inicial` | PASSED | 88.2 |
| `test_crear_la_primera_cuenta_lleva_al_panel_de_inicio` | PASSED | 219.8 |
| `test_no_permite_crear_una_cuenta_incompleta` | PASSED | 78.5 |
| `test_login_con_credenciales_correctas` | PASSED | 210.2 |
| `test_login_con_credenciales_incorrectas_muestra_error` | PASSED | 72.8 |
| `test_elegir_un_perfil_abre_la_sesion_de_analisis` | PASSED | 1614.2 |
| `test_el_video_se_embebe_en_la_ventana` | PASSED | 663.9 |
| `test_terminar_la_sesion_cierra_el_registro_y_libera_la_camara` | PASSED | 994.0 |
| `test_el_acceso_no_muestra_barra_lateral` | PASSED | 83.0 |
| `test_tras_autenticarse_aparece_la_barra_con_la_seccion_de_inicio_activa` | PASSED | 220.7 |
| `test_cada_seccion_de_la_barra_abre_su_pantalla[inicio-InicioScreen]` | PASSED | 294.3 |
| `test_cada_seccion_de_la_barra_abre_su_pantalla[vivo-LiveScreen]` | PASSED | 334.4 |
| `test_cada_seccion_de_la_barra_abre_su_pantalla[historial-HistorialScreen]` | PASSED | 264.9 |
| `test_cada_seccion_de_la_barra_abre_su_pantalla[tecnicas-TecnicasScreen]` | PASSED | 370.1 |
| `test_cada_seccion_de_la_barra_abre_su_pantalla[camara-CamaraScreen]` | PASSED | 304.5 |
| `test_la_calibracion_se_alcanza_desde_tecnicas_y_no_desde_la_barra` | PASSED | 560.9 |
| `test_la_barra_sobrevive_al_cambiar_de_seccion` | PASSED | 388.6 |
| `test_el_detalle_de_un_alumno_conserva_marcada_la_seccion_de_historial` | PASSED | 305.6 |
| `test_cerrar_sesion_de_entrenador_retira_la_barra_y_vuelve_al_acceso` | PASSED | 289.7 |
| `test_un_usuario_repetido_se_explica_en_pantalla_en_vez_de_reventar` | PASSED | 88.9 |

### `tests/e2e/test_gui_historial.py`

| Prueba | Estado | Tiempo (ms) |
|---|---|---|
| `test_el_historial_lista_a_todos_los_alumnos` | PASSED | 372.2 |
| `test_el_alumno_sin_entrenar_aparece_sin_precision` | PASSED | 344.3 |
| `test_volver_desde_el_historial_regresa_a_perfiles` | PASSED | 431.2 |
| `test_el_reporte_de_progreso_se_genera_desde_la_pantalla` | PASSED | 511.8 |
| `test_sin_evaluaciones_cerradas_se_explica_en_vez_de_generar_un_grafico_vacio` | PASSED | 344.8 |
| `test_el_perfil_muestra_el_desempeno_por_tecnica` | PASSED | 356.2 |
| `test_el_reporte_de_sesion_resume_y_ordena_los_errores` | PASSED | 341.5 |
| `test_un_reporte_de_sesion_inexistente_no_rompe_la_pantalla` | PASSED | 230.4 |
| `test_volver_desde_el_reporte_regresa_al_perfil_del_alumno` | PASSED | 489.0 |
| `test_la_biblioteca_muestra_las_tecnicas_que_el_sistema_evalua` | PASSED | 418.0 |
| `test_la_biblioteca_refleja_una_recalibracion_del_entrenador` | PASSED | 371.4 |
| `test_desde_la_biblioteca_se_llega_a_la_calibracion` | PASSED | 622.5 |

### `tests/e2e/test_gui_inicio.py`

| Prueba | Estado | Tiempo (ms) |
|---|---|---|
| `test_tras_autenticarse_se_abre_el_panel_de_inicio` | PASSED | 249.0 |
| `test_un_dojo_sin_actividad_lo_dice_en_vez_de_mostrar_cifras_en_cero` | PASSED | 252.8 |
| `test_el_panel_refleja_la_actividad_real_del_dojo` | PASSED | 329.9 |
| `test_el_panel_declara_que_no_hay_sensores_inerciales` | PASSED | 223.2 |
| `test_desde_el_inicio_se_llega_al_analisis_en_vivo_y_al_historial` | PASSED | 423.6 |
| `test_cambiar_de_perfil_pide_la_contrasena_del_sensei` | PASSED | 396.4 |
| `test_la_seleccion_lista_senseis_y_no_alumnos` | PASSED | 253.0 |
| `test_la_lista_de_senseis_nunca_expone_el_hash_de_la_contrasena` | PASSED | 11.2 |
| `test_los_alumnos_se_inscriben_desde_su_propia_seccion` | PASSED | 367.0 |
| `test_el_campo_de_grado_solo_aparece_para_cinta_cafe_o_negra` | PASSED | 340.0 |
| `test_un_formulario_invalido_no_inscribe_a_nadie` | PASSED | 352.5 |
| `test_abrir_el_registro_dos_veces_no_duplica_la_ventana` | PASSED | 340.8 |
| `test_el_reporte_señala_la_asimetria_entre_lados` | PASSED | 383.1 |
| `test_una_sesion_limpia_declara_que_no_hay_senales_de_riesgo` | PASSED | 367.6 |
| `test_el_reporte_traduce_los_errores_a_instrucciones` | PASSED | 380.7 |

### `tests/e2e/test_gui_umbrales.py`

| Prueba | Estado | Tiempo (ms) |
|---|---|---|
| `test_la_pantalla_lista_todos_los_umbrales_vigentes` | PASSED | 471.7 |
| `test_recalibrar_cambia_el_criterio_del_sistema_experto` | PASSED | 835.8 |
| `test_un_campo_invalido_no_guarda_ninguno_de_los_cambios` | PASSED | 450.0 |
| `test_guardar_sin_tocar_nada_no_crea_versiones_nuevas` | PASSED | 442.9 |
| `test_descartar_devuelve_los_campos_al_valor_vigente` | PASSED | 632.4 |
| `test_sin_entrenador_la_pantalla_queda_en_solo_lectura` | PASSED | 306.2 |
| `test_el_historial_abre_una_sola_ventana_con_las_versiones_del_umbral` | PASSED | 692.8 |
| `test_una_base_sin_umbrales_lo_informa_en_vez_de_mostrar_una_tabla_vacia` | PASSED | 447.7 |
| `test_volver_regresa_al_panel_de_inicio` | PASSED | 515.9 |

### `tests/e2e/test_gui_vivo.py`

| Prueba | Estado | Tiempo (ms) |
|---|---|---|
| `test_sin_alumno_elegido_no_se_abre_la_camara_ni_se_crea_sesion` | PASSED | 346.1 |
| `test_el_desplegable_ofrece_a_todos_los_alumnos_inscritos` | PASSED | 1011.5 |
| `test_cambiar_de_alumno_cierra_la_sesion_anterior_y_abre_otra` | PASSED | 1120.5 |
| `test_elegir_al_mismo_alumno_no_abre_una_sesion_nueva` | PASSED | 725.5 |
| `test_salir_de_la_seccion_cierra_la_sesion_en_curso` | PASSED | 787.5 |
| `test_el_video_se_ajusta_al_hueco_sin_deformarse` | PASSED | 574.5 |
| `test_el_escalado_nunca_devuelve_un_tamano_nulo` | PASSED | 615.3 |
| `test_un_fotograma_grande_no_agranda_el_contenedor_del_video` | PASSED | 559.1 |
| `test_el_tamano_de_dibujado_no_altera_los_angulos_medidos` | PASSED | 562.3 |
...
| `test_identifica_la_postura_antes_de_evaluarla[postura atrasada-165-105-KOKUTSU]` | PASSED | 0.5 |
...
| `test_una_patada_completa_atraviesa_el_analizador` | PASSED | 0.3 |
...
| `test_un_kokutsu_real_no_se_confunde_con_una_transicion[155-115]` | PASSED | 0.4 |
| `test_un_kokutsu_real_no_se_confunde_con_una_transicion[150-120]` | PASSED | 0.3 |
...
| `test_login_exitoso_de_un_entrenador_existente` | PASSED | 9.6 |
| `test_reintento_tras_una_contrasena_equivocada` | PASSED | 10.5 |
| `test_tras_fallar_puede_crear_una_cuenta_de_sensei_asistente` | PASSED | 11.2 |
| `test_elegir_un_perfil_existente_de_la_lista` | PASSED | 12.2 |
| `test_crear_un_perfil_nuevo_desde_la_lista` | PASSED | 11.2 |
| `test_el_grado_del_cinturon_es_opcional` | PASSED | 10.9 |
| `test_una_opcion_invalida_vuelve_a_preguntar[abc-texto en vez de n\xfamero]` | PASSED | 9.6 |
| `test_una_opcion_invalida_vuelve_a_preguntar[0-n\xfamero fuera de rango por abajo]` | PASSED | 9.6 |
| `test_una_opcion_invalida_vuelve_a_preguntar[99-n\xfamero fuera de rango por arriba]` | PASSED | 9.6 |

### `tests/integration/test_configuracion.py`

| Prueba | Estado | Tiempo (ms) |
|---|---|---|
| `test_una_preferencia_no_configurada_devuelve_el_valor_por_defecto` | PASSED | 7.8 |
| `test_la_preferencia_sobrevive_al_reinicio_del_sistema` | PASSED | 8.9 |
| `test_reconfigurar_reemplaza_en_vez_de_duplicar` | PASSED | 9.3 |
| `test_los_valores_se_guardan_como_texto` | PASSED | 9.0 |
| `test_la_migracion_no_toca_una_base_ya_existente` | PASSED | 9.5 |

### `tests/integration/test_consultas_progreso.py`

| Prueba | Estado | Tiempo (ms) |
|---|---|---|
| `test_la_precision_ignora_los_estados_transitorios` | PASSED | 15.4 |
| `test_un_alumno_sin_mediciones_aparece_con_precision_desconocida` | PASSED | 18.9 |
| `test_todos_los_alumnos_aparecen_aunque_no_hayan_entrenado` | PASSED | 20.4 |
| `test_las_sesiones_se_listan_de_la_mas_reciente_a_la_mas_antigua` | PASSED | 21.8 |
| `test_cada_sesion_trae_su_propia_precision` | PASSED | 20.9 |
| `test_una_sesion_abierta_se_distingue_de_una_cerrada` | PASSED | 21.5 |
| `test_un_alumno_sin_sesiones_devuelve_lista_vacia` | PASSED | 33.8 |
| `test_las_tecnicas_se_ordenan_de_la_mas_floja_a_la_mas_solida` | PASSED | 20.3 |
| `test_el_desempeno_puede_acotarse_a_una_sola_sesion` | PASSED | 24.3 |
| `test_el_angulo_medio_se_promedia_por_tecnica` | PASSED | 22.3 |
| `test_el_detalle_de_sesion_identifica_al_alumno_y_al_entrenador` | PASSED | 29.9 |
| `test_una_sesion_inexistente_devuelve_none` | PASSED | 22.8 |
| `test_los_errores_se_agrupan_y_ordenan_por_frecuencia` | PASSED | 21.7 |
| `test_una_sesion_sin_errores_no_reporta_correcciones` | PASSED | 28.1 |

### `tests/integration/test_database.py`

| Prueba | Estado | Tiempo (ms) |
|---|---|---|
| `test_primer_arranque_no_tiene_entrenadores` | PASSED | 11.0 |
| `test_registro_y_autenticacion_exitosa` | PASSED | 11.9 |
| `test_credenciales_invalidas_no_dan_acceso[sholweger-clave_incorrecta-contrase\xf1a equivocada]` | PASSED | 11.6 |
| `test_credenciales_invalidas_no_dan_acceso[usuario_inexistente-clave123-usuario que no existe]` | PASSED | 11.1 |
| `test_credenciales_invalidas_no_dan_acceso[SHOLWEGER-clave123-usuario con distinta capitalizaci\xf3n]` | PASSED | 10.6 |
| `test_credenciales_invalidas_no_dan_acceso[--credenciales vac\xedas]` | PASSED | 10.4 |
| `test_la_contrasena_nunca_se_guarda_en_texto_plano` | PASSED | 12.1 |
| `test_no_se_permiten_dos_entrenadores_con_el_mismo_usuario` | PASSED | 10.6 |
| `test_el_rol_por_defecto_es_sensei` | PASSED | 10.0 |
| `test_los_atletas_se_listan_alfabeticamente` | PASSED | 37.0 |
| `test_crear_atleta_devuelve_un_identificador_utilizable` | PASSED | 12.1 |
| `test_los_datos_opcionales_del_atleta_pueden_omitirse` | PASSED | 14.7 |
| `test_una_sesion_abierta_no_tiene_hora_de_fin` | PASSED | 17.4 |
| `test_cerrar_sesion_registra_la_hora_de_fin` | PASSED | 18.9 |
| `test_la_sesion_queda_ligada_al_atleta_y_al_entrenador` | PASSED | 15.8 |
| `test_guardar_y_recuperar_una_medicion` | PASSED | 13.1 |
| `test_el_veredicto_se_persiste_en_los_tres_estados[True-1]` | PASSED | 10.9 |
| `test_el_veredicto_se_persiste_en_los_tres_estados[False-0]` | PASSED | 10.6 |
| `test_el_veredicto_se_persiste_en_los_tres_estados[None-None]` | PASSED | 10.8 |
| `test_el_historial_solo_devuelve_las_mediciones_del_atleta_consultado` | PASSED | 12.3 |
| `test_un_atleta_sin_entrenamientos_tiene_historial_vacio` | PASSED | 9.4 |
| `test_las_mediciones_sobreviven_al_cierre_de_la_aplicacion` | PASSED | 12.2 |
| `test_migra_una_base_de_datos_creada_sin_la_columna_correcto` | PASSED | 10.6 |
| `test_abrir_dos_veces_la_misma_base_no_duplica_el_esquema` | PASSED | 9.9 |
...
| Prueba | Estado | Tiempo (ms) |
|---|---|---|
| `test_treinta_frames_identicos_generan_una_sola_fila` | PASSED | 12.0 |
| `test_cada_cambio_real_de_diagnostico_se_registra` | PASSED | 15.8 |
| `test_un_diagnostico_repetido_tras_cambiar_se_vuelve_a_registrar` | PASSED | 19.1 |
| `test_las_categorias_se_rastrean_por_separado` | PASSED | 15.7 |
| `test_traduce_la_categoria_interna_a_un_nombre_legible` | PASSED | 18.4 |
| `test_ignora_entradas_que_no_son_diagnosticos_reales[diagnostico0-mensaje vac\xedo (solo dibuja el n\xfamero del \xe1ngulo en pantalla)]` | PASSED | 10.5 |
| `test_ignora_entradas_que_no_son_diagnosticos_reales[diagnostico1-sin categor\xeda]` | PASSED | 13.2 |
| `test_ignora_entradas_que_no_son_diagnosticos_reales[diagnostico2-diccionario incompleto]` | PASSED | 12.9 |
| `test_conserva_angulo_veredicto_y_marca_de_tiempo` | PASSED | 14.3 |
| `test_registra_una_lista_completa_de_diagnosticos_de_un_frame` | PASSED | 16.8 |

### `tests/integration/test_panel_inicio.py`

| Prueba | Estado | Tiempo (ms) |
|---|---|---|
| `test_un_alumno_puede_inscribirse_solo_con_su_nombre` | PASSED | 13.7 |
| `test_la_ficha_completa_se_guarda_y_se_recupera` | PASSED | 11.7 |
| `test_un_alumno_inexistente_devuelve_none_en_vez_de_reventar` | PASSED | 11.0 |
| `test_la_migracion_agrega_la_ficha_a_una_base_que_ya_tenia_alumnos` | PASSED | 19.9 |
| `test_un_dojo_sin_actividad_no_reporta_cero_por_ciento` | PASSED | 11.1 |
| `test_la_ventana_de_actividad_deja_fuera_las_sesiones_viejas` | PASSED | 30.5 |
| `test_los_estados_transitorios_no_alteran_las_metricas_del_panel` | PASSED | 23.6 |
| `test_las_sesiones_recientes_abarcan_a_todo_el_dojo` | PASSED | 13.6 |
| `test_las_sesiones_recientes_respetan_el_limite` | PASSED | 17.6 |
| `test_sin_sesiones_la_lista_viene_vacia_y_no_falla` | PASSED | 8.6 |
| `test_las_tecnicas_se_ordenan_por_cuanto_se_practican` | PASSED | 29.6 |
| `test_las_tecnicas_practicadas_pueden_acotarse_a_la_ventana_reciente` | PASSED | 21.6 |
| `test_el_desempeno_se_separa_por_lado_del_cuerpo` | PASSED | 27.0 |
| `test_los_diagnosticos_sin_lado_no_se_atribuyen_a_ninguno` | PASSED | 24.7 |
| `test_se_cuentan_los_diagnosticos_que_contienen_un_fragmento` | PASSED | 29.9 |
| `test_una_sesion_sin_mediciones_devuelve_ceros_y_no_none` | PASSED | 12.9 |
...
| `test_dibuja_el_esqueleto_cuando_hay_pose` | PASSED | 3.0 |
| `test_el_mapa_anatomico_no_referencia_puntos_inexistentes` | PASSED | 0.3 |
| `test_dibuja_el_texto_del_diagnostico` | PASSED | 51.3 |
| `test_un_diagnostico_sin_angulo_no_rompe_el_dibujado` | PASSED | 1.3 |
| `test_una_lista_vacia_de_diagnosticos_deja_el_frame_igual` | PASSED | 1.0 |
| `test_el_color_del_diagnostico_llega_al_frame` | PASSED | 1.2 |
...
| `test_calcula_el_porcentaje_de_aciertos[veredictos2-50.0]` | PASSED | 0.4 |
...
| `test_no_genera_grafica_si_la_sesion_no_dejo_evaluaciones` | PASSED | 17.7 |
| `test_genera_un_png_con_el_historial_de_dos_sesiones` | PASSED | 266.0 |
| `test_crea_la_carpeta_de_evidencias_si_no_existe` | PASSED | 169.5 |
| `test_dos_reportes_seguidos_no_se_sobrescriben` | PASSED | 324.4 |

### `tests/integration/test_umbrales.py`

| Prueba | Estado | Tiempo (ms) |
|---|---|---|
| `test_la_siembra_es_idempotente` | PASSED | 12.5 |
| `test_las_reglas_usan_los_umbrales_de_la_base` | PASSED | 11.6 |
| `test_recalibrar_crea_version_nueva_sin_borrar_la_anterior` | PASSED | 10.7 |
| `test_la_medicion_conserva_el_umbral_que_la_juzgo` | PASSED | 15.6 |
| `test_rechaza_un_maximo_menor_que_el_minimo` | PASSED | 10.7 |
| `test_la_maquina_de_estados_hereda_el_umbral_de_kime` | PASSED | 11.7 |
| `test_sin_base_de_datos_usa_los_valores_de_literatura` | PASSED | 0.2 |
| `test_un_umbral_sin_maximo_no_limita_por_arriba` | PASSED | 0.2 |
| `test_una_correccion_de_literatura_alcanza_a_una_base_ya_sembrada` | PASSED | 14.1 |
| `test_una_correccion_no_pisa_lo_que_el_entrenador_recalibro` | PASSED | 12.2 |
| `test_aplicar_la_correccion_dos_veces_no_crea_versiones_repetidas` | PASSED | 10.2 |
...
| `test_reduce_la_dispersion_del_ruido` | PASSED | 0.5 |
...
| `test_calcula_el_angulo_interno_conocido[extension total-a1-b1-c1-180.0]` | PASSED | 0.4 |
...
| `test_reconstruye_cualquier_angulo_del_rango_articular[179]` | PASSED | 0.4 |
...
| `test_normaliza_angulos_reflejos_al_rango_articular[350-10]` | PASSED | 0.5 |
| `test_el_resultado_nunca_sale_del_rango_0_180[0]` | PASSED | 0.4 |
...
| `test_es_invariante_a_la_distancia_a_la_camara[2]` | PASSED | 0.4 |
...
| `test_kiba_dachi_exige_simetria_en_ambas_rodillas[129-140-False]` | PASSED | 0.3 |
| `test_kiba_dachi_exige_simetria_en_ambas_rodillas[140-151-False]` | PASSED | 0.3 |
| `test_kiba_dachi_exige_simetria_en_ambas_rodillas[170-170-False]` | PASSED | 0.3 |
...
| `test_kokutsu_dachi_carga_el_peso_en_la_pierna_trasera[160-140-False]` | PASSED | 0.4 |
...
| `test_mae_geri_rechaza_kime_incompleto_aunque_sea_veloz[159.9-900]` | PASSED | 0.3 |
...
| `test_age_uke_bloquea_solo_en_su_rango[140.0-True-EFECTIVO]` | PASSED | 0.4 |
...
| `test_descarta_fotogramas_de_calentamiento` | PASSED | 0.4 |
...
| Prueba | Estado | Tiempo (ms) |
|---|---|---|
| `test_los_nombres_de_macos_salen_en_el_orden_en_que_el_sistema_los_reporta` | PASSED | 0.3 |
...
| `test_solo_se_devuelven_los_indices_pedidos` | PASSED | 0.3 |
...
| Prueba | Estado | Tiempo (ms) |
|---|---|---|
| `test_el_tiempo_se_lee_como_un_cronometro[0-00:00]` | PASSED | 0.5 |
...
| `test_ningun_campo_obligatorio_puede_quedar_vacio[datos_entrada]` | PASSED | 0.4 |
...
| `test_un_hueco_real_es_incumplimiento_en_una_corrida_completa` | PASSED | 0.3 |
| `test_un_hueco_por_modulos_omitidos_es_solo_un_aviso` | PASSED | 0.2 |
| `test_un_modulo_sin_ficha_sigue_siendo_incumplimiento_aunque_haya_omitidos` | PASSED | 0.3 |
...
| `test_la_linea_de_comandos_elige_la_via_correcta[argumentos1-consola]` | PASSED | 0.5 |
...
| `test_la_edad_se_interpreta_o_queda_vacia[16-16]` | PASSED | 0.4 |
| `test_la_edad_se_interpreta_o_queda_vacia[  8 -8]` | PASSED | 0.3 |
| `test_la_edad_se_interpreta_o_queda_vacia[-None]` | PASSED | 0.5 |
| `test_la_edad_se_interpreta_o_queda_vacia[   -None]` | PASSED | 0.4 |
| `test_una_edad_imposible_se_explica_en_lugar_de_guardarse[diecis\xe9is-no es un n\xfamero]` | PASSED | 0.5 |
| `test_una_edad_imposible_se_explica_en_lugar_de_guardarse[16.5-no es un n\xfamero]` | PASSED | 0.5 |
| `test_una_edad_imposible_se_explica_en_lugar_de_guardarse[2-entre 3 y 99]` | PASSED | 0.7 |
| `test_una_edad_imposible_se_explica_en_lugar_de_guardarse[150-entre 3 y 99]` | PASSED | 0.6 |
| `test_una_edad_imposible_se_explica_en_lugar_de_guardarse[-4-entre 3 y 99]` | PASSED | 0.4 |
| `test_el_peso_admite_coma_decimal[62.5-62.5]` | PASSED | 0.3 |
| `test_el_peso_admite_coma_decimal[62,5-62.5]` | PASSED | 0.4 |
| `test_el_peso_admite_coma_decimal[ 70 -70.0]` | PASSED | 0.4 |
...
| `test_el_analisis_declara_donde_termina_su_alcance` | PASSED | 0.3 |
...
| `test_el_valor_mostrado_es_legible_para_el_entrenador[160.0-160]` | PASSED | 0.4 |
| `test_el_valor_mostrado_es_legible_para_el_entrenador[160.5-160.5]` | PASSED | 0.3 |
| `test_el_valor_mostrado_es_legible_para_el_entrenador[None-sin l\xedmite]` | PASSED | 0.9 |
